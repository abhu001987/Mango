/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'agriculture-navigator-india';
...
const ROUNDS = [
  ...
  { id:'rice', name:'Rice', region:'',
    fact:"Uttar Pradesh is India's leading rice-producing state in 2024–25. Telangana and West Bengal are the next major producers, with Punjab, Odisha and Chhattisgarh also important rice-growing states.",
    states:['Uttar Pradesh'],
    paths: siteBox(26.80, 81.00, 0.45)
  },

  { id:'wheat', name:'Wheat', region:'',
    fact:"Uttar Pradesh is India's leading wheat-producing state. Madhya Pradesh and Punjab are the next major producers, while Haryana and Rajasthan are also important wheat-growing states.",
    states:['Uttar Pradesh'],
    paths: siteBox(27.00, 80.50, 0.45)
  },

  { id:'maize', name:'Maize', region:'',
    fact:"Madhya Pradesh is India's leading maize-producing state in 2024–25, followed by Karnataka and Maharashtra. Bihar and Telangana are also major maize producers.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.80, 78.80, 0.40)
  },

  { id:'jowar', name:'Jowar / Sorghum', region:'',
    fact:"Maharashtra is India's leading jowar-producing state. Karnataka and Madhya Pradesh are the next important producers, with the crop concentrated mainly in the Deccan Plateau.",
    states:['Maharashtra'],
    paths: siteBox(18.70, 75.50, 0.45)
  },

  { id:'bajra', name:'Bajra / Pearl Millet', region:'',
    fact:"Rajasthan is India's leading bajra-producing state. Uttar Pradesh and Gujarat are the next major producers, with Haryana and Maharashtra also important.",
    states:['Rajasthan'],
    paths: siteBox(27.00, 74.00, 0.50)
  },

  { id:'ragi', name:'Ragi / Finger Millet', region:'',
    fact:"Karnataka is India's leading ragi-producing state. Tamil Nadu and Uttarakhand are the next important producers, with Maharashtra and Odisha also cultivating the crop.",
    states:['Karnataka'],
    paths: siteBox(13.40, 77.30, 0.35)
  },

  { id:'pulses', name:'Total Pulses', region:'',
    fact:"Madhya Pradesh is India's leading pulse-producing state. Maharashtra and Rajasthan are the next major producers, making central and western India the country's main pulse belt.",
    states:['Madhya Pradesh'],
    paths: siteBox(23.20, 78.50, 0.45)
  },

  { id:'gram', name:'Gram / Chickpea', region:'',
    fact:"Madhya Pradesh is India's leading gram-producing state. Maharashtra and Rajasthan are the next major producers, with Karnataka also an important chickpea-growing state.",
    states:['Madhya Pradesh'],
    paths: siteBox(23.00, 77.50, 0.45)
  },

  { id:'tur', name:'Tur / Arhar', region:'',
    fact:"Maharashtra is India's leading tur-producing state. Karnataka and Madhya Pradesh are the next important producers, while Telangana is another major tur-growing region.",
    states:['Maharashtra'],
    paths: siteBox(18.90, 76.00, 0.45)
  },

  { id:'groundnut', name:'Groundnut', region:'',
    fact:"Gujarat is India's leading groundnut-producing state. Rajasthan and Tamil Nadu are the next major producers, with Andhra Pradesh and Karnataka also important.",
    states:['Gujarat'],
    paths: siteBox(22.40, 71.80, 0.45)
  },

  { id:'soybean', name:'Soybean', region:'',
    fact:"Madhya Pradesh is India's leading soybean-producing state. Maharashtra and Rajasthan are the next major producers, forming India's principal soybean belt.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.90, 76.50, 0.45)
  },

  { id:'rapeseed_mustard', name:'Rapeseed & Mustard', region:'',
    fact:"Rajasthan is India's leading rapeseed and mustard-producing state. Haryana and Madhya Pradesh are the next major producers, with Uttar Pradesh also important.",
    states:['Rajasthan'],
    paths: siteBox(27.00, 74.50, 0.45)
  },

  { id:'sunflower', name:'Sunflower', region:'',
    fact:"Karnataka is India's leading sunflower-producing state. Maharashtra and Telangana are the next important producers, particularly across the Deccan Plateau.",
    states:['Karnataka'],
    paths: siteBox(16.50, 76.50, 0.45)
  },

  { id:'sugarcane', name:'Sugarcane', region:'',
    fact:"Uttar Pradesh is India's leading sugarcane-producing state. Maharashtra and Karnataka are the next major producers and together form India's major sugarcane belt.",
    states:['Uttar Pradesh'],
    paths: siteBox(28.50, 80.00, 0.50)
  },

  { id:'cotton', name:'Cotton', region:'',
    fact:"Maharashtra is India's leading cotton-producing state in 2024–25, followed closely by Gujarat and Telangana. Madhya Pradesh and Rajasthan are also important cotton producers.",
    states:['Maharashtra'],
    paths: siteBox(20.80, 76.50, 0.50)
  },

  { id:'jute', name:'Jute', region:'',
    fact:"West Bengal is India's dominant jute-producing state. Bihar and Assam are the next major producers, with cultivation concentrated in the humid Ganga-Brahmaputra plains.",
    states:['West Bengal'],
    paths: siteBox(23.20, 88.50, 0.45)
  },

  { id:'tobacco', name:'Tobacco', region:'',
    fact:"Andhra Pradesh is India's leading tobacco-producing state. Karnataka and Gujarat are the next major producers, with important tobacco-growing belts in the southern and western states.",
    states:['Andhra Pradesh'],
    paths: siteBox(16.00, 80.50, 0.45)
  },

  { id:'tea', name:'Tea', region:'',
    fact:"Assam is India's leading tea-producing state. West Bengal and Tamil Nadu are the next major producers, with Darjeeling and the Nilgiris being famous specialty tea regions.",
    states:['Assam'],
    paths: siteBox(26.60, 92.80, 0.50)
  },

  { id:'coffee', name:'Coffee', region:'',
    fact:"Karnataka is India's leading coffee-producing state. Kerala and Tamil Nadu are the next major producers, with the main coffee belt located along the Western Ghats.",
    states:['Karnataka'],
    paths: siteBox(12.50, 75.80, 0.45)
  },

  { id:'rubber', name:'Natural Rubber', region:'',
    fact:"Kerala is India's leading natural-rubber-producing state. Tripura and Karnataka are the next important producers, while Tamil Nadu and Assam also cultivate rubber.",
    states:['Kerala'],
    paths: siteBox(9.60, 76.50, 0.40)
  },

  { id:'coconut', name:'Coconut', region:'',
    fact:"Karnataka is India's leading coconut-producing state. Tamil Nadu and Kerala are the next major producers, forming the country's principal coconut belt.",
    states:['Karnataka'],
    paths: siteBox(12.50, 76.50, 0.45)
  },

  { id:'potato', name:'Potato', region:'',
    fact:"Uttar Pradesh is India's leading potato-producing state. West Bengal and Bihar are the next major producers, with Uttar Pradesh and West Bengal together forming India's major potato belt.",
    states:['Uttar Pradesh'],
    paths: siteBox(27.00, 80.50, 0.45)
  },

  { id:'onion', name:'Onion', region:'',
    fact:"Maharashtra is India's leading onion-producing state. Madhya Pradesh and Karnataka are the next major producers, with Nashik being India's best-known onion-growing region.",
    states:['Maharashtra'],
    paths: siteBox(20.00, 74.00, 0.35)
  },

  { id:'tomato', name:'Tomato', region:'',
    fact:"Andhra Pradesh is one of India's leading tomato-producing states. Madhya Pradesh and Karnataka are the next major producers, with Maharashtra and Odisha also important.",
    states:['Andhra Pradesh'],
    paths: siteBox(14.80, 79.50, 0.40)
  },

  { id:'banana', name:'Banana', region:'',
    fact:"Andhra Pradesh is India's leading banana-producing state. Maharashtra and Gujarat are the next major producers, with Tamil Nadu and Karnataka also important banana-growing states.",
    states:['Andhra Pradesh'],
    paths: siteBox(15.00, 79.80, 0.45)
  },

  { id:'mango', name:'Mango', region:'',
    fact:"Uttar Pradesh is India's leading mango-producing state. Andhra Pradesh and Bihar are the next major producers, while Maharashtra and Telangana are also important.",
    states:['Uttar Pradesh'],
    paths: siteBox(26.50, 80.50, 0.45)
  },

  { id:'apple', name:'Apple', region:'',
    fact:"Jammu & Kashmir is India's leading apple-producing region. Himachal Pradesh and Uttarakhand are the next major producers, forming India's principal Himalayan apple belt.",
    states:['Jammu & Kashmir'],
    paths: siteBox(33.80, 75.30, 0.45)
  },

  { id:'orange', name:'Orange', region:'',
    fact:"Madhya Pradesh is a major orange-producing state, particularly around the Chhindwara region. Maharashtra and Rajasthan are other important orange-producing states.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.10, 78.90, 0.35)
  },

  { id:'grapes', name:'Grapes', region:'',
    fact:"Maharashtra is India's leading grape-producing state, particularly around Nashik and Sangli. Karnataka and Tamil Nadu are the next important grape-producing states.",
    states:['Maharashtra'],
    paths: siteBox(20.00, 74.00, 0.30)
  },

  { id:'turmeric', name:'Turmeric', region:'',
    fact:"Telangana is India's leading turmeric-producing state. Maharashtra and Karnataka are the next major producers, with Nizamabad being one of India's best-known turmeric-growing areas.",
    states:['Telangana'],
    paths: siteBox(18.70, 78.20, 0.35)
  },

  { id:'chilli', name:'Chilli', region:'',
    fact:"Andhra Pradesh is India's leading chilli-producing state. Telangana and Karnataka are the next major producers, with Guntur being one of India's most famous chilli markets.",
    states:['Andhra Pradesh'],
    paths: siteBox(16.30, 80.45, 0.30)
  },

  { id:'black_pepper', name:'Black Pepper', region:'',
    fact:"Kerala is India's leading black-pepper-producing state. Karnataka and Tamil Nadu are the next major producers, with the Western Ghats forming India's principal pepper-growing belt.",
    states:['Kerala'],
    paths: siteBox(10.00, 76.00, 0.40)
  },

  { id:'cardamom', name:'Cardamom', region:'',
    fact:"Kerala is India's leading small-cardamom-producing state. Karnataka and Tamil Nadu are the next important producers, with the Cardamom Hills of Kerala being particularly famous.",
    states:['Kerala'],
    paths: siteBox(9.90, 77.10, 0.30)
  },

  { id:'coriander', name:'Coriander', region:'',
    fact:"Rajasthan is India's leading coriander-producing state. Madhya Pradesh and Gujarat are the next major producers, making western and central India the principal coriander belt.",
    states:['Rajasthan'],
    paths: siteBox(24.50, 75.80, 0.35)
  },

  { id:'cumin', name:'Cumin', region:'',
    fact:"Gujarat is India's leading cumin-producing state. Rajasthan is the next major producer, with the dry northwestern climate of both states particularly suited to cumin cultivation.",
    states:['Gujarat'],
    paths: siteBox(23.00, 71.50, 0.45)
  },

  { id:'isabgol', name:'Isabgol / Psyllium', region:'',
    fact:"Gujarat is India's leading isabgol-producing state. Rajasthan is the next important producer, with the crop concentrated in the dry northwestern parts of India.",
    states:['Gujarat'],
    paths: siteBox(23.60, 72.20, 0.40)
  },

  { id:'sesame', name:'Sesame', region:'',
    fact:"West Bengal is India's leading sesame-producing state. Uttar Pradesh and Madhya Pradesh are the next major producers, with Gujarat and Rajasthan also important.",
    states:['West Bengal'],
    paths: siteBox(23.80, 87.80, 0.40)
  },

  { id:'linseed', name:'Linseed', region:'',
    fact:"Madhya Pradesh is India's leading linseed-producing state. Chhattisgarh and Uttar Pradesh are other important producers, with the crop mainly grown during the rabi season.",
    states:['Madhya Pradesh'],
    paths: siteBox(23.50, 79.00, 0.40)
  },

  { id:'safflower', name:'Safflower', region:'',
    fact:"Maharashtra is India's leading safflower-producing state. Karnataka and Telangana are the next important producers, with the crop mainly grown in the Deccan Plateau.",
    states:['Maharashtra'],
    paths: siteBox(18.80, 75.00, 0.40)
  },

  { id:'castor', name:'Castor Seed', region:'',
    fact:"Gujarat is India's leading castor-seed-producing state. Rajasthan and Andhra Pradesh are the next major producers, with Gujarat accounting for a large share of India's castor production.",
    states:['Gujarat'],
    paths: siteBox(23.20, 72.00, 0.45)
  },

  { id:'oil_palm', name:'Oil Palm', region:'',
    fact:"Andhra Pradesh is India's leading oil-palm-producing state. Telangana and Kerala are other important producing states, with cultivation concentrated in irrigated tropical regions.",
    states:['Andhra Pradesh'],
    paths: siteBox(16.50, 81.00, 0.45)
  },

  { id:'barley', name:'Barley', region:'',
  fact:"Rajasthan is India's leading barley-producing state. Uttar Pradesh and Haryana are the next major producers, with Madhya Pradesh also contributing significantly.",
  states:['Rajasthan'],
  paths: siteBox(27.00, 74.00, 0.45)
},

{ id:'moong', name:'Moong / Green Gram', region:'',
  fact:"Rajasthan is India's leading moong-producing state. Maharashtra and Karnataka are the next major producers, with Madhya Pradesh also an important producer.",
  states:['Rajasthan'],
  paths: siteBox(26.50, 73.80, 0.45)
},

{ id:'urad', name:'Urad / Black Gram', region:'',
  fact:"Madhya Pradesh is India's leading urad-producing state. Uttar Pradesh and Andhra Pradesh are the next major producers.",
  states:['Madhya Pradesh'],
  paths: siteBox(23.00, 78.20, 0.45)
},

{ id:'masoor', name:'Masoor / Lentil', region:'',
  fact:"Madhya Pradesh is India's leading lentil-producing state. Uttar Pradesh and West Bengal are the next major producers.",
  states:['Madhya Pradesh'],
  paths: siteBox(23.20, 78.20, 0.45)
},

{ id:'pea', name:'Peas', region:'',
  fact:"Uttar Pradesh is India's leading pea-producing state. Madhya Pradesh and Bihar are the next major producers.",
  states:['Uttar Pradesh'],
  paths: siteBox(27.00, 80.50, 0.45)
},

{ id:'arecanut', name:'Arecanut', region:'',
  fact:"Karnataka is India's leading arecanut-producing state. Kerala and Assam are the next major producers.",
  states:['Karnataka'],
  paths: siteBox(14.50, 75.80, 0.40)
},

{ id:'cashew', name:'Cashew', region:'',
  fact:"Maharashtra is India's leading cashew-producing state. Andhra Pradesh and Odisha are the next major producers.",
  states:['Maharashtra'],
  paths: siteBox(17.80, 73.80, 0.45)
},

{ id:'cocoa', name:'Cocoa', region:'',
  fact:"Andhra Pradesh is India's leading cocoa-producing state. Karnataka and Kerala are the next important producers.",
  states:['Andhra Pradesh'],
  paths: siteBox(16.00, 80.80, 0.40)
},

{ id:'guava', name:'Guava', region:'',
  fact:"Uttar Pradesh is India's leading guava-producing state. Madhya Pradesh and Bihar are the next major producers.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.80, 80.50, 0.45)
},

{ id:'papaya', name:'Papaya', region:'',
  fact:"Andhra Pradesh is India's leading papaya-producing state. Gujarat and Maharashtra are the next major producers.",
  states:['Andhra Pradesh'],
  paths: siteBox(15.80, 80.00, 0.45)
},

{ id:'pineapple', name:'Pineapple', region:'',
  fact:"West Bengal is India's leading pineapple-producing state. Assam and Tripura are the next major producers.",
  states:['West Bengal'],
  paths: siteBox(24.00, 88.20, 0.40)
},

{ id:'pomegranate', name:'Pomegranate', region:'',
  fact:"Maharashtra is India's leading pomegranate-producing state. Karnataka and Gujarat are the next major producers.",
  states:['Maharashtra'],
  paths: siteBox(19.00, 75.00, 0.40)
},

{ id:'litchi', name:'Litchi', region:'',
  fact:"Bihar is India's leading litchi-producing state. West Bengal and Jharkhand are the next major producers.",
  states:['Bihar'],
  paths: siteBox(25.80, 85.50, 0.35)
},

{ id:'ginger', name:'Ginger', region:'',
  fact:"Assam is India's leading ginger-producing state. Meghalaya and Mizoram are the next major producers.",
  states:['Assam'],
  paths: siteBox(26.40, 92.80, 0.40)
},

{ id:'garlic', name:'Garlic', region:'',
  fact:"Madhya Pradesh is India's leading garlic-producing state. Rajasthan and Gujarat are the next major producers.",
  states:['Madhya Pradesh'],
  paths: siteBox(23.20, 76.80, 0.40)
},

{ id:'fenugreek', name:'Fenugreek', region:'',
  fact:"Rajasthan is India's leading fenugreek-producing state. Gujarat and Madhya Pradesh are the next major producers.",
  states:['Rajasthan'],
  paths: siteBox(26.50, 74.50, 0.40)
},

{ id:'fennel', name:'Fennel', region:'',
  fact:"Gujarat is India's leading fennel-producing state. Rajasthan is the next major producer.",
  states:['Gujarat'],
  paths: siteBox(22.80, 71.80, 0.40)
},

{ id:'clove', name:'Clove', region:'',
  fact:"Tamil Nadu is India's leading clove-producing state. Kerala and Karnataka are the next important producers.",
  states:['Tamil Nadu'],
  paths: siteBox(10.50, 77.00, 0.30)
},

{ id:'cinnamon', name:'Cinnamon', region:'',
  fact:"Kerala is India's leading cinnamon-producing state. Karnataka and Tamil Nadu also cultivate cinnamon.",
  states:['Kerala'],
  paths: siteBox(10.00, 76.20, 0.35)
},

{ id:'nutmeg', name:'Nutmeg', region:'',
  fact:"Kerala is India's leading nutmeg-producing state. Karnataka and Tamil Nadu are the next important producers.",
  states:['Kerala'],
  paths: siteBox(10.00, 76.30, 0.35)
}
