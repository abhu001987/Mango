/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'tiger-navigator-india';
...
const ROUNDS = [
  ...
  { id:'nagarjunasagar_srisailam', name:'Nagarjunsagar-Srisailam Tiger Reserve', region:'',
    fact:"India's largest tiger reserve by area, spread across the Nallamala Hills and centered on the Krishna River. It provides habitat for tigers, leopards, sloth bears and the endangered Indian pangolin.",
    states:['Andhra Pradesh'],
    paths: siteBox(16.10, 78.75, 0.55)
  },
  ...
  { id:'namdapha_tr', name:'Namdapha Tiger Reserve', region:'',
    fact:"One of India's most biodiverse tiger reserves, located in the Eastern Himalaya near the Myanmar border. Its enormous altitude range supports tropical forests, temperate forests and alpine habitats, with tiger, clouded leopard and other big cats.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.50, 96.40, 0.35)
  },

  { id:'pakke', name:'Pakke Tiger Reserve', region:'',
    fact:"Pakke is a major tiger reserve in the Eastern Himalaya known for tropical forests and hornbill diversity. It forms part of an important forest corridor connecting protected areas of Arunachal Pradesh and Assam.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.10, 92.90, 0.25)
  },

  { id:'kamlang', name:'Kamlang Tiger Reserve', region:'',
    fact:"Kamlang lies in the eastern part of Arunachal Pradesh and contains tropical and subtropical forests. It is known for tiger, clouded leopard, hoolock gibbon and other Eastern Himalayan wildlife.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.38, 96.85, 0.25)
  },
  ...
  { id:'kaziranga', name:'Kaziranga Tiger Reserve', region:'',
    fact:"Kaziranga lies on the floodplains of the Brahmaputra and is famous for its very large population of one-horned rhinoceros. Its grasslands, wetlands and forests also support tigers, elephants, wild water buffalo and swamp deer.",
    states:['Assam'],
    paths: siteBox(26.58, 93.17, 0.30)
  },

  { id:'manas_tr', name:'Manas Tiger Reserve', region:'',
    fact:"Manas lies along the Bhutan border in the Himalayan foothills and forms part of the Manas National Park landscape. It supports tiger, elephant, wild water buffalo, golden langur and several rare species.",
    states:['Assam'],
    paths: siteBox(26.72, 91.00, 0.35)
  },

  { id:'nameri', name:'Nameri Tiger Reserve', region:'',
    fact:"Nameri lies along the Jia-Bhoreli River near the Arunachal Pradesh border. Its forests and riverine habitats support tiger, elephant, leopard and the endangered white-winged wood duck.",
    states:['Assam'],
    paths: siteBox(27.00, 92.85, 0.20)
  },

  { id:'orang', name:'Orang Tiger Reserve', region:'',
    fact:"Orang lies on the northern bank of the Brahmaputra and is often called the 'mini Kaziranga' because of its similar floodplain grassland ecosystem. It supports tiger, one-horned rhinoceros, wild water buffalo and elephants.",
    states:['Assam'],
    paths: siteBox(26.55, 92.30, 0.20)
  },
  ...
  { id:'valmiki', name:'Valmiki Tiger Reserve', region:'',
    fact:"Valmiki is Bihar's only tiger reserve, located in the Himalayan foothills along the Nepal border. Its forests are part of the Terai-Duar ecosystem and form an important tiger corridor with Nepal's Chitwan landscape.",
    states:['Bihar'],
    paths: siteBox(27.45, 84.25, 0.25)
  },
  ...
  { id:'indravati', name:'Indravati Tiger Reserve', region:'',
    fact:"Indravati is one of the major tiger reserves of central India, located in the Bastar region along the Indravati River. Its dry deciduous forests support tiger, wild buffalo, leopard and dhole.",
    states:['Chhattisgarh'],
    paths: siteBox(18.80, 81.15, 0.35)
  },

  { id:'udanti_sitanadi', name:'Udanti-Sitanadi Tiger Reserve', region:'',
    fact:"Udanti-Sitanadi consists of two important forest landscapes in central Chhattisgarh. It is particularly significant for conservation of the endangered wild water buffalo and forms part of the central Indian tiger landscape.",
    states:['Chhattisgarh'],
    paths: siteBox(20.35, 82.20, 0.35)
  },

  { id:'achanacmar', name:'Achanakmar Tiger Reserve', region:'',
    fact:"Achanakmar lies in the Maikal ranges of central India and forms part of an important tiger corridor linking Madhya Pradesh and Chhattisgarh. Its sal-dominated forests support tigers, leopards, sloth bears and gaur.",
    states:['Chhattisgarh'],
    paths: siteBox(22.55, 81.85, 0.25)
  },

  { id:'guru_ghasidas_tamor_pingla', name:'Guru Ghasidas-Tamor Pingla Tiger Reserve', region:'',
    fact:"Guru Ghasidas-Tamor Pingla is a large tiger landscape in northern Chhattisgarh connected to tiger habitats of Madhya Pradesh and Jharkhand. It was notified as a tiger reserve in 2024 and is important for landscape-level tiger conservation.",
    states:['Chhattisgarh'],
    paths: siteBox(23.55, 82.95, 0.45)
  },
  ...
  { id:'bhagwan_mahavir', name:'Bhagwan Mahavir Tiger Reserve', region:'',
    fact:"Goa's major protected forest landscape in the Western Ghats, centered around Bhagwan Mahavir Wildlife Sanctuary and Mollem National Park. It contains evergreen and deciduous forests supporting leopard, gaur and other Western Ghats wildlife.",
    states:['Goa'],
    paths: siteBox(15.30, 74.25, 0.20)
  },
  ...
  { id:'palamau', name:'Palamau Tiger Reserve', region:'',
    fact:"Palamau is one of the original Project Tiger reserves launched in 1973. Located in the Chota Nagpur Plateau, its dry deciduous forests support tiger, elephant, gaur, sloth bear and other central Indian wildlife.",
    states:['Jharkhand'],
    paths: siteBox(23.80, 84.20, 0.30)
  },
  ...
  { id:'bandipur', name:'Bandipur Tiger Reserve', region:'',
    fact:"Bandipur is one of India's most important tiger landscapes and forms a continuous forest complex with Nagarhole, Wayanad and Mudumalai. It lies in the Nilgiri Biosphere Reserve and supports large populations of tiger and Asian elephant.",
    states:['Karnataka'],
    paths: siteBox(11.65, 76.63, 0.30)
  },

  { id:'biligiri_ranganatha', name:'Biligiri Ranganatha Temple Tiger Reserve', region:'',
    fact:"BRT Tiger Reserve connects the Eastern and Western Ghats and acts as an important wildlife corridor. Its forests support tiger, elephant, leopard, gaur and several species characteristic of both mountain systems.",
    states:['Karnataka'],
    paths: siteBox(11.95, 77.15, 0.25)
  },

  { id:'bhadra', name:'Bhadra Tiger Reserve', region:'',
    fact:"Bhadra lies in the Western Ghats of Karnataka and contains moist deciduous and evergreen forests around the Bhadra reservoir. It supports tiger, leopard, elephant, gaur and diverse Western Ghats flora.",
    states:['Karnataka'],
    paths: siteBox(13.55, 75.65, 0.25)
  },

  { id:'dandeli_anza', name:'Kali Tiger Reserve', region:'',
    fact:"Kali Tiger Reserve, formerly associated with Dandeli-Anshi, protects a large forest landscape of the northern Western Ghats. It is known for black panther sightings, hornbills, tiger, leopard and gaur.",
    states:['Karnataka'],
    paths: siteBox(15.05, 74.55, 0.30)
  },

  { id:'nagarhole', name:'Nagarhole Tiger Reserve', region:'',
    fact:"Nagarhole forms part of the Nilgiri landscape and is connected to Bandipur and Wayanad. Its moist deciduous forests around the Kabini region support high densities of tiger and Asian elephant.",
    states:['Karnataka'],
    paths: siteBox(12.05, 76.10, 0.30)
  },
  ...
  { id:'periyar', name:'Periyar Tiger Reserve', region:'',
    fact:"Periyar lies in the southern Western Ghats around the Periyar Lake. It is famous for Asian elephants, tigers, gaur and rich evergreen and moist deciduous forests and forms part of the larger Periyar landscape.",
    states:['Kerala'],
    paths: siteBox(9.47, 77.20, 0.25)
  },

  { id:'parambikulam', name:'Parambikulam Tiger Reserve', region:'',
    fact:"Parambikulam lies in the Western Ghats and forms part of a larger trans-boundary forest landscape with Anamalai Tiger Reserve in Tamil Nadu. It contains rich evergreen and moist deciduous forests supporting tiger, elephant and gaur.",
    states:['Kerala'],
    paths: siteBox(10.45, 76.75, 0.25)
  },
  ...
  { id:'kanha', name:'Kanha Tiger Reserve', region:'',
    fact:"Kanha is one of India's best-known tiger reserves in the Maikal range. Its sal and bamboo forests are famous for tiger and barasingha conservation and are often associated with the landscape that inspired The Jungle Book.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.33, 80.61, 0.30)
  },

  { id:'bandhavgarh', name:'Bandhavgarh Tiger Reserve', region:'',
    fact:"Bandhavgarh is known for a high density of Bengal tigers and its historic hilltop fort. Its sal and mixed deciduous forests lie in the Vindhyan landscape of eastern Madhya Pradesh.",
    states:['Madhya Pradesh'],
    paths: siteBox(23.70, 81.05, 0.25)
  },

  { id:'pench_mp', name:'Pench Tiger Reserve', region:'',
    fact:"Pench lies in the Satpura landscape and straddles the Madhya Pradesh-Maharashtra border. Its forests and Pench River ecosystem are associated with the landscape that inspired Rudyard Kipling's The Jungle Book.",
    states:['Madhya Pradesh'],
    paths: siteBox(21.65, 79.25, 0.25)
  },

  { id:'panna', name:'Panna Tiger Reserve', region:'',
    fact:"Panna lies along the Ken River in the Vindhyan region. It became a major tiger conservation success story after local tiger extinction was followed by successful reintroduction and population recovery.",
    states:['Madhya Pradesh'],
    paths: siteBox(24.70, 80.15, 0.30)
  },

  { id:'satpura', name:'Satpura Tiger Reserve', region:'',
    fact:"Satpura protects a rugged forested landscape in the Satpura ranges and includes Satpura National Park, Bori Wildlife Sanctuary and Pachmarhi Sanctuary. It supports tiger, leopard, sloth bear, gaur and wild dog.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.55, 78.35, 0.30)
  },

  { id:'sanjay', name:'Sanjay-Dubri Tiger Reserve', region:'',
    fact:"Sanjay-Dubri lies in the eastern Satpura-Maikal landscape and forms part of a major tiger corridor between Madhya Pradesh, Uttar Pradesh and Chhattisgarh. Its forests support tiger, leopard, sloth bear and gaur.",
    states:['Madhya Pradesh'],
    paths: siteBox(24.55, 81.55, 0.30)
  },

  { id:'ratapani', name:'Ratapani Tiger Reserve', region:'',
    fact:"Ratapani is a forested tiger landscape in central Madhya Pradesh near Bhopal. It contains dry deciduous forests and important wildlife corridors and was notified as a tiger reserve in 2024.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.80, 77.60, 0.25)
  },

  { id:'veerangana_durgavati', name:'Veerangana Durgavati Tiger Reserve', region:'',
    fact:"Veerangana Durgavati is a large tiger reserve in the Narmada-Ken landscape of Madhya Pradesh. It provides an important ecological link between Panna and other central Indian tiger habitats and was notified in 2023.",
    states:['Madhya Pradesh'],
    paths: siteBox(23.25, 79.45, 0.40)
  },

  { id:'madhav', name:'Madhav Tiger Reserve', region:'',
    fact:"Madhav Tiger Reserve in Shivpuri district was notified in 2025, becoming India's 58th tiger reserve. It contains dry deciduous forests and the Sakhya Sagar wetland and strengthens tiger conservation in the northern Madhya Pradesh landscape.",
    states:['Madhya Pradesh'],
    paths: siteBox(25.45, 77.75, 0.25)
  },
  ...
  { id:'melghat', name:'Melghat Tiger Reserve', region:'',
    fact:"Melghat is one of the original Project Tiger reserves and lies in the Satpura ranges of Maharashtra. Its rugged teak and dry deciduous forests support tiger, gaur, sloth bear and wild dog.",
    states:['Maharashtra'],
    paths: siteBox(21.35, 77.25, 0.40)
  },

  { id:'tadoba_andhari', name:'Tadoba-Andhari Tiger Reserve', region:'',
    fact:"Tadoba-Andhari is one of Maharashtra's best-known tiger reserves and is famous for frequent tiger sightings. Its dry deciduous forests, bamboo and water bodies support tiger, leopard, sloth bear and wild dog.",
    states:['Maharashtra'],
    paths: siteBox(20.25, 79.35, 0.30)
  },

  { id:'pench_mh', name:'Pench Tiger Reserve', region:'',
    fact:"The Maharashtra portion of Pench forms part of the same trans-state tiger landscape as Pench Tiger Reserve in Madhya Pradesh. The Pench River and surrounding teak forests provide important tiger habitat.",
    states:['Maharashtra'],
    paths: siteBox(21.55, 79.15, 0.25)
  },

  { id:'sahyadri', name:'Sahyadri Tiger Reserve', region:'',
    fact:"Sahyadri Tiger Reserve lies in the northern Western Ghats and includes Koyna Wildlife Sanctuary and Chandoli National Park. Its evergreen and moist deciduous forests form an important tiger corridor in western India.",
    states:['Maharashtra'],
    paths: siteBox(17.35, 73.75, 0.30)
  },

  { id:'bor', name:'Bor Tiger Reserve', region:'',
    fact:"Bor Tiger Reserve is a relatively small protected forest landscape in Maharashtra's Wardha district. It lies within the central Indian tiger landscape and provides habitat and connectivity for tigers and other wildlife.",
    states:['Maharashtra'],
    paths: siteBox(20.98, 78.68, 0.18)
  },

  { id:'navegaon_nagzira', name:'Navegaon-Nagzira Tiger Reserve', region:'',
    fact:"Navegaon-Nagzira is an important forest complex in eastern Maharashtra containing lakes, teak and mixed deciduous forests. It forms part of the central Indian tiger landscape and provides connectivity toward Madhya Pradesh and Chhattisgarh.",
    states:['Maharashtra'],
    paths: siteBox(21.30, 80.20, 0.30)
  },
  ...
  { id:'dampa', name:'Dampa Tiger Reserve', region:'',
    fact:"Dampa is Mizoram's only tiger reserve and lies along the Bangladesh border in the Lushai Hills. Its tropical evergreen and semi-evergreen forests support tiger, leopard, clouded leopard and hoolock gibbon.",
    states:['Mizoram'],
    paths: siteBox(23.55, 92.40, 0.25)
  },
  ...
  { id:'nt_nagaland', name:'Intanki National Park', region:'',
    fact:"Intanki is a protected forest landscape in Nagaland and forms part of the state's important wildlife habitat. It contains tropical and subtropical forests supporting a range of northeastern Indian wildlife.",
    states:['Nagaland'],
    paths: siteBox(25.70, 93.65, 0.20)
  },
  ...
  { id:'similipal', name:'Similipal Tiger Reserve', region:'',
    fact:"Similipal is a major tiger landscape in northern Odisha and a UNESCO Biosphere Reserve. Its sal forests, waterfalls and rugged terrain support tiger, elephant, gaur and the distinctive melanistic tiger population.",
    states:['Odisha'],
    paths: siteBox(21.65, 86.35, 0.35)
  },

  { id:'satkosia', name:'Satkosia Tiger Reserve', region:'',
    fact:"Satkosia protects the Mahanadi River as it cuts through the Eastern Ghats. Its dry deciduous forests, riverine habitats and gorge landscape support tiger, leopard, elephant and gharial.",
    states:['Odisha'],
    paths: siteBox(20.60, 84.70, 0.30)
  },
  ...
  { id:'ranthambore', name:'Ranthambore Tiger Reserve', region:'',
    fact:"Ranthambore is one of India's most famous tiger reserves, located in the dry forests and rocky terrain of southeastern Rajasthan. The historic Ranthambore Fort lies within the landscape.",
    states:['Rajasthan'],
    paths: siteBox(26.05, 76.50, 0.30)
  },

  { id:'sariska', name:'Sariska Tiger Reserve', region:'',
    fact:"Sariska lies in the Aravalli hills of Rajasthan and is known for its successful tiger reintroduction programme after local tiger extinction. Its dry deciduous forests also support leopard, sambar and chital.",
    states:['Rajasthan'],
    paths: siteBox(27.40, 76.55, 0.25)
  },

  { id:'ramgarh_vishdhari', name:'Ramgarh Vishdhari Tiger Reserve', region:'',
    fact:"Ramgarh Vishdhari lies in the Hadoti region of southeastern Rajasthan and forms an important corridor between Ranthambore and the forests of Madhya Pradesh. It was notified as a tiger reserve in 2022.",
    states:['Rajasthan'],
    paths: siteBox(25.50, 75.75, 0.25)
  },

  { id:'dholpur_karauli', name:'Dholpur-Karauli Tiger Reserve', region:'',
    fact:"Dholpur-Karauli is a tiger reserve in eastern Rajasthan containing dry deciduous forests and ravine landscapes along the Chambal. It was notified in 2023 and forms part of the Ranthambore-Chambal landscape.",
    states:['Rajasthan'],
    paths: siteBox(26.75, 77.15, 0.30)
  },
  ...
  { id:'kawal', name:'Kawal Tiger Reserve', region:'',
    fact:"Kawal lies in the northern Deccan plateau of Telangana and contains dry deciduous forests. It is an important tiger corridor connecting tiger habitats of Telangana with Maharashtra and central India.",
    states:['Telangana'],
    paths: siteBox(19.20, 79.45, 0.35)
  },

  { id:'amrabad', name:'Amrabad Tiger Reserve', region:'',
    fact:"Amrabad is one of India's largest tiger reserves and occupies the Nallamala Hills of Telangana. It forms the northern part of the larger Nallamala tiger landscape connected with Nagarjunsagar-Srisailam.",
    states:['Telangana'],
    paths: siteBox(16.35, 78.90, 0.45)
  },
  ...
  { id:'mudumalai', name:'Mudumalai Tiger Reserve', region:'',
    fact:"Mudumalai lies in the Nilgiri Hills and forms a crucial wildlife corridor between Karnataka and Kerala. It is part of the Nilgiri Biosphere Reserve and supports tiger, elephant, gaur and dhole.",
    states:['Tamil Nadu'],
    paths: siteBox(11.58, 76.55, 0.22)
  },

  { id:'annanmalai', name:'Anamalai Tiger Reserve', region:'',
    fact:"Anamalai lies in the southern Western Ghats and contains evergreen, moist deciduous and montane forests. It forms a trans-boundary landscape with Parambikulam Tiger Reserve in Kerala.",
    states:['Tamil Nadu'],
    paths: siteBox(10.45, 76.95, 0.30)
  },

  { id:'kalakkad_mundanthurai', name:'Kalakkad-Mundanthurai Tiger Reserve', region:'',
    fact:"Kalakkad-Mundanthurai is a major tiger reserve in the southern Western Ghats and one of Tamil Nadu's most important forest landscapes. Its evergreen forests contain high levels of Western Ghats endemism.",
    states:['Tamil Nadu'],
    paths: siteBox(8.65, 77.35, 0.30)
  },

  { id:'srivilliputhur_meghamalai', name:'Srivilliputhur-Meghamalai Tiger Reserve', region:'',
    fact:"Srivilliputhur-Meghamalai protects a large forest landscape in the southern Western Ghats and connects the forests of Tamil Nadu with Kerala. It was notified as a tiger reserve in 2021.",
    states:['Tamil Nadu'],
    paths: siteBox(9.65, 77.45, 0.30)
  },

  { id:'sathyamangalam', name:'Sathyamangalam Tiger Reserve', region:'',
    fact:"Sathyamangalam is a major wildlife corridor between the Western and Eastern Ghats. Its dry deciduous forests connect the Nilgiri landscape with forests of eastern Tamil Nadu and support tiger, elephant and leopard.",
    states:['Tamil Nadu'],
    paths: siteBox(11.55, 77.20, 0.30)
  },
  ...
  { id:'dudhwa', name:'Dudhwa Tiger Reserve', region:'',
    fact:"Dudhwa is the major tiger landscape of the Terai region of Uttar Pradesh along the Nepal border. Its grasslands, sal forests and wetlands support tiger, one-horned rhinoceros, swamp deer and elephants.",
    states:['Uttar Pradesh'],
    paths: siteBox(28.45, 80.65, 0.35)
  },

  { id:'pilibhit', name:'Pilibhit Tiger Reserve', region:'',
    fact:"Pilibhit lies in the Terai Arc Landscape and contains sal forests, grasslands and wetlands. It is connected ecologically with tiger habitats across the Nepal border and was notified as a tiger reserve in 2014.",
    states:['Uttar Pradesh'],
    paths: siteBox(28.65, 80.20, 0.25)
  },

  { id:'ranipur', name:'Ranipur Tiger Reserve', region:'',
    fact:"Ranipur is located in the Bundelkhand landscape of southern Uttar Pradesh. Its dry deciduous forests and rocky terrain provide an important tiger corridor toward Madhya Pradesh and was notified as a tiger reserve in 2022.",
    states:['Uttar Pradesh'],
    paths: siteBox(25.30, 80.95, 0.25)
  },
  ...
  { id:'corbett', name:'Corbett Tiger Reserve', region:'',
    fact:"Corbett is India's oldest national park and one of the original Project Tiger reserves. Located in the Himalayan foothills, it is famous for tigers, elephants, sal forests and the Ramganga river system.",
    states:['Uttarakhand'],
    paths: siteBox(29.53, 78.77, 0.30)
  },

  { id:'rajaji', name:'Rajaji Tiger Reserve', region:'',
    fact:"Rajaji lies in the Shivalik hills and forms a critical elephant and tiger corridor between the western and central Himalayan landscapes. It was notified as a tiger reserve in 2015.",
    states:['Uttarakhand'],
    paths: siteBox(30.05, 78.10, 0.30)
  },
  ...
  { id:'sundarban', name:'Sundarban Tiger Reserve', region:'',
    fact:"Sundarban is India's only major mangrove tiger habitat and lies in the Ganga-Brahmaputra-Meghna delta. Its saline mangrove forests support the Royal Bengal tiger, estuarine crocodile and aquatic wildlife.",
    states:['West Bengal'],
    paths: siteBox(21.95, 88.90, 0.35)
  },

  { id:'buxa', name:'Buxa Tiger Reserve', region:'',
    fact:"Buxa lies in the eastern Himalayan foothills of northern West Bengal along the Bhutan border. It is an important tiger corridor between India and Bhutan and contains diverse forests and river systems.",
    states:['West Bengal'],
    paths: siteBox(26.70, 89.55, 0.30)
  }
