/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'biosphere-navigator-india';
...
const ROUNDS = [
  ...
  { id:'nilgiri', name:'Nilgiri Biosphere Reserve', region:'',
    fact:"India's first Biosphere Reserve, established in 1986. It spans the Western Ghats across Tamil Nadu, Kerala and Karnataka and includes parts of Bandipur, Nagarhole, Mudumalai, Wayanad and Silent Valley landscapes. It is part of UNESCO's World Network.",
    states:['Tamil Nadu','Kerala','Karnataka'],
    paths: siteBox(11.45, 76.65, 0.45)
  },

  { id:'nanda_devi', name:'Nanda Devi Biosphere Reserve', region:'',
    fact:"Located in the high Himalaya of Uttarakhand and centered on Nanda Devi National Park and Valley of Flowers National Park. It protects alpine ecosystems and species such as snow leopard, Himalayan musk deer and bharal. It is a UNESCO World Network site.",
    states:['Uttarakhand'],
    paths: siteBox(30.65, 79.75, 0.25)
  },

  { id:'gulf_of_mannar', name:'Gulf of Mannar Biosphere Reserve', region:'',
    fact:"India's first marine Biosphere Reserve, established in 1989. It covers a chain of islands and coastal waters between Tamil Nadu and Sri Lanka and is famous for coral reefs, seagrass beds, mangroves and dugongs. It is a UNESCO World Network site.",
    states:['Tamil Nadu'],
    paths: siteBox(9.10, 79.15, 0.35)
  },

  { id:'great_nicobar', name:'Great Nicobar Biosphere Reserve', region:'',
    fact:"A major island biosphere reserve in the southern Nicobar Islands containing tropical evergreen forests, coastal ecosystems and important endemic wildlife. The Nicobar megapode, Nicobar tree shrew and leatherback turtle are notable species. It is a UNESCO World Network site.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(7.00, 93.80, 0.30)
  },

  { id:'similipal', name:'Similipal Biosphere Reserve', region:'',
    fact:"A large forested landscape of northern Odisha containing Similipal National Park and Tiger Reserve. It is dominated by sal forests and supports tigers, elephants and the distinctive melanistic tiger population. It is a UNESCO World Network site.",
    states:['Odisha'],
    paths: siteBox(21.65, 86.35, 0.30)
  },

  { id:'sundarbans', name:'Sundarbans Biosphere Reserve', region:'',
    fact:"Part of the world's largest contiguous mangrove ecosystem in the Ganga-Brahmaputra-Meghna delta. It is famous for the Royal Bengal tiger, estuarine crocodile and tidal mangrove forests. The Sundarbans is a UNESCO World Network site.",
    states:['West Bengal'],
    paths: siteBox(21.95, 88.90, 0.35)
  },

  { id:'dibru_saikhowa', name:'Dibru-Saikhowa Biosphere Reserve', region:'',
    fact:"A floodplain wetland and forest ecosystem in Assam formed by the Brahmaputra and Dibru rivers. It is known for feral horses, white-winged wood duck, swamp forests and extensive grasslands.",
    states:['Assam'],
    paths: siteBox(27.60, 95.30, 0.30)
  },

  { id:'manas', name:'Manas Biosphere Reserve', region:'',
    fact:"A Himalayan foothill biosphere reserve along the Bhutan border containing Manas National Park. It is famous for tigers, elephants, golden langurs, pygmy hogs and wild water buffalo. It is a UNESCO World Network site.",
    states:['Assam'],
    paths: siteBox(26.72, 91.00, 0.30)
  },

  { id:'nokrek', name:'Nokrek Biosphere Reserve', region:'',
    fact:"Located in the Garo Hills of Meghalaya and centered on Nokrek National Park. It protects subtropical and tropical forests and is famous for the wild citrus species Citrus indica, considered an important genetic resource. It is a UNESCO World Network site.",
    states:['Meghalaya'],
    paths: siteBox(25.48, 90.35, 0.25)
  },

  { id:'dehang_debang', name:'Dihang-Dibang Biosphere Reserve', region:'',
    fact:"A vast high-altitude Himalayan biosphere reserve in Arunachal Pradesh covering the upper Dibang and Siang landscapes. It contains tropical forests at lower elevations and alpine ecosystems at higher elevations and supports Mishmi takin, red goral and clouded leopard.",
    states:['Arunachal Pradesh'],
    paths: siteBox(28.50, 95.00, 0.45)
  },

  { id:'kachchh', name:'Kachchh Biosphere Reserve', region:'',
    fact:"A large arid and semi-arid biosphere landscape in Gujarat covering the Rann of Kachchh and surrounding ecosystems. It protects desert and saline habitats supporting wild ass, flamingos and other desert and wetland species.",
    states:['Gujarat'],
    paths: siteBox(23.75, 69.20, 0.45)
  },

  { id:'pachmarhi', name:'Pachmarhi Biosphere Reserve', region:'',
    fact:"Located in the Satpura ranges of Madhya Pradesh and containing Satpura National Park, Bori Wildlife Sanctuary and Pachmarhi Sanctuary. It represents the central Indian highland ecosystem and supports gaur, tiger, leopard and giant squirrel.",
    states:['Madhya Pradesh'],
    paths: siteBox(22.50, 78.40, 0.30)
  },

  { id:'achanacmar_amarakantak', name:'Achanakmar-Amarkantak Biosphere Reserve', region:'',
    fact:"A trans-state biosphere reserve covering parts of Madhya Pradesh and Chhattisgarh in the Maikal range. It protects sal and mixed deciduous forests and lies around the source region of the Narmada and Son rivers. It is a UNESCO World Network site.",
    states:['Madhya Pradesh','Chhattisgarh'],
    paths: siteBox(22.65, 81.75, 0.35)
  },

  { id:'panna', name:'Panna Biosphere Reserve', region:'',
    fact:"Located in the Vindhyan landscape of Madhya Pradesh and centered on Panna Tiger Reserve and the Ken River ecosystem. It is known for tiger conservation, dry deciduous forests, the Ken River and extensive ravines. It is a UNESCO World Network site.",
    states:['Madhya Pradesh'],
    paths: siteBox(24.65, 80.20, 0.30)
  },

  { id:'seshaschalam', name:'Seshachalam Biosphere Reserve', region:'',
    fact:"Located in the Eastern Ghats of Andhra Pradesh around the Tirumala and Seshachalam hills. It contains dry deciduous and scrub forests and is especially important for the endemic red sanders tree, Pterocarpus santalinus.",
    states:['Andhra Pradesh'],
    paths: siteBox(13.65, 79.35, 0.30)
  },

  { id:'agastyamalai', name:'Agasthyamalai Biosphere Reserve', region:'',
    fact:"A Western Ghats biosphere reserve spanning Kerala and Tamil Nadu and centered on the Agasthyamalai hills. It contains tropical forests with very high endemism and includes important protected areas such as Neyyar, Peppara and Shendurney. It is a UNESCO World Network site.",
    states:['Kerala','Tamil Nadu'],
    paths: siteBox(8.65, 77.25, 0.35)
  },

  { id:'khangchendzonga', name:'Khangchendzonga Biosphere Reserve', region:'',
    fact:"A high-altitude Himalayan biosphere reserve in Sikkim centered on Mount Khangchendzonga and Khangchendzonga National Park. It contains ecosystems ranging from subtropical forests to glaciers and alpine meadows and is a UNESCO World Network site.",
    states:['Sikkim'],
    paths: siteBox(27.65, 88.30, 0.35)
  },

  { id:'cold_desert', name:'Cold Desert Biosphere Reserve', region:'',
    fact:"India's high-altitude cold-desert Biosphere Reserve in Himachal Pradesh, covering the Lahaul-Spiti landscape. It includes Pin Valley National Park, Kibber Wildlife Sanctuary and Chandratal and supports snow leopard, blue sheep and other trans-Himalayan species. It became India's 13th Biosphere Reserve in UNESCO's World Network in 2025.",
    states:['Himachal Pradesh'],
    paths: siteBox(32.25, 77.95, 0.55)
  }
  ...
  try{
    ...
    if(mine[g]){
      fetchGame(g).then(data=>{
        ...
        console.warn('Could not load your challenge:', e);
        showToast("Couldn't load your challenge — showing your last saved result");
        // Fall back to what we already have cached locally, so the screen isn't stuck
        currentGameCode = g;
        currentAvgScore = mine[g].avg;
        scores = mine[g].scores;
        mode = 'challenge';
    ...
    fetchGame(g).then(gameData=>{ showChallengeInvite(g, gameData); })
      .catch(e=>{
        ...
        showToast("Couldn't load that challenge link — try refreshing");
        document.getElementById('screen-start').classList.remove('hidden');
        setHeaderVisible(true);
        // Clean the broken ?g= param off the URL so refresh doesn't just fail again
        try{
          const url = new URL(window.location.href);
          url.searchParams.delete('g');
          window.history.replaceState({}, '', url.toString());
    ...
    console.warn('Malformed challenge link:', e);
    showToast('This challenge link looks invalid');
  }
})();
