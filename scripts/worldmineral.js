/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'Minerals-navigator';
...
const ROUNDS = [
  ...
  { id:'iron_ore', name:'Iron Ore', region:'',
    fact:"Australia is the world's leading producer of iron ore. Brazil ranks second and China third. The Pilbara region of Western Australia is Australia's most important iron-ore producing region.",
    countries:['Australia'],
    paths:[[[23.36,119.73],[23.36,119.73]]]
  },

  { id:'coal', name:'Coal', region:'',
    fact:"China is the world's largest coal producer. India ranks second and Indonesia third. Major Chinese coalfields occur in Shanxi, Inner Mongolia and Shaanxi.",
    countries:['China'],
    paths:[[[37.85,112.55],[37.85,112.55]]]
  },

  { id:'bauxite', name:'Bauxite', region:'',
    fact:"Guinea is the world's leading producer of bauxite. Australia ranks second and China third. Guinea's Boké region contains some of the world's most important bauxite deposits.",
    countries:['Guinea'],
    paths:[[[11.30,-13.85],[11.30,-13.85]]]
  },

  { id:'manganese', name:'Manganese', region:'',
    fact:"South Africa is the world's leading producer of manganese ore. Gabon ranks second and Australia third. The Kalahari manganese field is one of the world's largest manganese-producing regions.",
    countries:['South Africa'],
    paths:[[[-25.85,25.65],[-25.85,25.65]]]
  },

  { id:'chromium', name:'Chromium', region:'',
    fact:"South Africa is the world's leading producer of chromite. Kazakhstan ranks second and Turkey third. The Bushveld Complex is one of the world's major chromium-producing regions.",
    countries:['South Africa'],
    paths:[[[-25.40,30.05],[-25.40,30.05]]]
  },

  { id:'nickel', name:'Nickel', region:'',
    fact:"Indonesia is the world's leading producer of nickel. The Philippines ranks second and Russia third. Indonesia's nickel resources are concentrated particularly in Sulawesi and North Maluku.",
    countries:['Indonesia'],
    paths:[[[1.30,128.50],[1.30,128.50]]]
  },

  { id:'cobalt', name:'Cobalt', region:'',
    fact:"The Democratic Republic of the Congo is the world's leading producer of mined cobalt. Indonesia ranks second and Russia is among the next major producers. Most Congolese cobalt comes from the Copperbelt.",
    countries:['Democratic Republic of the Congo'],
    paths:[[[-10.70,26.70],[-10.70,26.70]]]
  },

  { id:'copper', name:'Copper', region:'',
    fact:"Chile is the world's leading producer of mined copper. The Democratic Republic of the Congo ranks second and Peru third. Chile's Atacama region contains many of its giant copper mines.",
    countries:['Chile'],
    paths:[[[-27.30,-69.50],[-27.30,-69.50]]]
  },

  { id:'gold', name:'Gold', region:'',
    fact:"China is the world's leading producer of mined gold. Russia ranks second and Australia third. China's major gold-producing areas include Shandong and the northeastern provinces.",
    countries:['China'],
    paths:[[[43.80,87.60],[43.80,87.60]]]
  },

  { id:'silver', name:'Silver', region:'',
    fact:"Mexico is the world's leading producer of silver. China ranks second and Peru third. Mexico's major silver-producing belt extends through states such as Zacatecas and Durango.",
    countries:['Mexico'],
    paths:[[[23.20,-102.50],[23.20,-102.50]]]
  },

  { id:'lead', name:'Lead', region:'',
    fact:"China is the world's leading producer of mined lead. Australia ranks second and Peru third. Lead is commonly associated with zinc and silver deposits.",
    countries:['China'],
    paths:[[[35.50,105.00],[35.50,105.00]]]
  },

  { id:'zinc', name:'Zinc', region:'',
    fact:"China is the world's leading producer of mined zinc. Peru ranks second and Australia third. Zinc is commonly produced together with lead and silver.",
    countries:['China'],
    paths:[[[34.50,105.50],[34.50,105.50]]]
  },

  { id:'tin', name:'Tin', region:'',
    fact:"China is the world's leading producer of tin. Indonesia ranks second and Myanmar third. The Southeast Asian tin belt is one of the world's most important tin-producing regions.",
    countries:['China'],
    paths:[[[29.00,102.00],[29.00,102.00]]]
  },

  { id:'lithium', name:'Lithium', region:'',
    fact:"Australia is the world's leading producer of mined lithium. Chile ranks second and China third. Western Australia's hard-rock mines are particularly important for global lithium supply.",
    countries:['Australia'],
    paths:[[[-30.95,121.50],[-30.95,121.50]]]
  },

  { id:'diamond', name:'Diamond', region:'',
    fact:"Russia is the world's leading producer of natural diamonds by carat output. Botswana ranks second and Canada third. Yakutia in Russia contains some of the world's most important diamond mines.",
    countries:['Russia'],
    paths:[[[66.00,123.00],[66.00,123.00]]]
  },

  { id:'uranium', name:'Uranium', region:'',
    fact:"Kazakhstan is the world's leading producer of uranium. Canada ranks second and Namibia third. Kazakhstan's uranium deposits are concentrated mainly in the Chu-Sarysu and Syrdarya basins.",
    countries:['Kazakhstan'],
    paths:[[[44.00,67.50],[44.00,67.50]]]
  },

  { id:'platinum', name:'Platinum', region:'',
    fact:"South Africa is the world's leading producer of platinum. Russia ranks second and Zimbabwe third. South Africa's Bushveld Complex is the world's dominant platinum-producing region.",
    countries:['South Africa'],
    paths:[[[-25.50,27.00],[-25.50,27.00]]]
  },

  { id:'palladium', name:'Palladium', region:'',
    fact:"Russia is the world's leading producer of mined palladium. South Africa ranks second and Canada is among the other major producers. Russia's Norilsk region is especially important.",
    countries:['Russia'],
    paths:[[[69.00,88.00],[69.00,88.00]]]
  },

  { id:'niobium', name:'Niobium', region:'',
    fact:"Brazil overwhelmingly dominates world niobium production. Canada ranks second, while other countries contribute only small quantities. Brazil's Araxá region is particularly important.",
    countries:['Brazil'],
    paths:[[[-19.60,-46.95],[-19.60,-46.95]]]
  },

  { id:'tungsten', name:'Tungsten', region:'',
    fact:"China is the world's leading producer of tungsten. Vietnam ranks second and Russia is among the next major producers. China's tungsten deposits are especially important in Jiangxi and Hunan.",
    countries:['China'],
    paths:[[[26.80,113.00],[26.80,113.00]]]
  },

  { id:'molybdenum', name:'Molybdenum', region:'',
    fact:"China is the world's leading producer of molybdenum. Chile ranks second and the United States third. Molybdenum is commonly associated with copper porphyry deposits.",
    countries:['China'],
    paths:[[[41.80,123.40],[41.80,123.40]]]
  },

  { id:'vanadium', name:'Vanadium', region:'',
    fact:"China is the world's leading producer of vanadium. Russia ranks second and South Africa third. Much of China's vanadium is recovered from vanadium-bearing titaniferous magnetite.",
    countries:['China'],
    paths:[[[39.00,106.00],[39.00,106.00]]]
  },

  { id:'antimony', name:'Antimony', region:'',
    fact:"China is the world's leading producer of mined antimony. Russia ranks second and Tajikistan is among the next major producers. China has important antimony deposits in Hunan.",
    countries:['China'],
    paths:[[[27.50,111.50],[27.50,111.50]]]
  },

  { id:'graphite', name:'Natural Graphite', region:'',
    fact:"China is the world's leading producer of natural graphite. Madagascar ranks second and Mozambique is among the next major producers. Graphite is especially important for lithium-ion battery anodes.",
    countries:['China'],
    paths:[[[41.80,123.40],[41.80,123.40]]]
  },

  { id:'rare_earths', name:'Rare Earth Elements', region:'',
    fact:"China is the world's leading producer of rare-earth elements. The United States ranks second and Myanmar third. China's Bayan Obo deposit in Inner Mongolia is one of the world's largest rare-earth deposits.",
    countries:['China'],
    paths:[[[41.80,109.95],[41.80,109.95]]]
  },

  { id:'phosphate_rock', name:'Phosphate Rock', region:'',
    fact:"China is the world's leading producer of phosphate rock. Morocco ranks second and the United States third. Phosphate rock is the main raw material for phosphate fertilizers.",
    countries:['China'],
    paths:[[[30.60,111.50],[30.60,111.50]]]
  },

  { id:'potash', name:'Potash', region:'',
    fact:"Canada is the world's leading producer of potash. Russia ranks second and Belarus third. Saskatchewan contains the world's largest potash-producing region.",
    countries:['Canada'],
    paths:[[[50.90,-106.70],[50.90,-106.70]]]
  },

  { id:'salt', name:'Salt', region:'',
    fact:"China is the world's leading producer of salt. India ranks second and the United States is among the other major producers. Salt is produced from seawater, brines and rock-salt deposits.",
    countries:['China'],
    paths:[[[35.50,110.00],[35.50,110.00]]]
  },

  { id:'gypsum', name:'Gypsum', region:'',
    fact:"The United States is one of the world's leading producers of gypsum. Iran and China are also among the major producers. Gypsum is widely used in plaster, wallboard and cement.",
    countries:['United States of America'],
    paths:[[[32.80,-105.50],[32.80,-105.50]]]
  },

  { id:'mica', name:'Mica', region:'',
    fact:"India is one of the world's leading producers of sheet mica. China and Madagascar are also important sources. India's major mica belt extends through Jharkhand, Andhra Pradesh and Rajasthan.",
    countries:['India'],
    paths:[[[24.00,85.00],[24.00,85.00]]]
  },

  { id:'feldspar', name:'Feldspar', region:'',
    fact:"Turkey is the world's leading producer of feldspar. India and China are among the other major producers. Feldspar is widely used in glass and ceramic industries.",
    countries:['Turkey'],
    paths:[[[38.50,28.50],[38.50,28.50]]]
  },

  { id:'fluorspar', name:'Fluorspar', region:'',
    fact:"China is the world's leading producer of fluorspar. Mexico ranks second and Mongolia is among the next major producers. Fluorspar is the principal commercial source of fluorine.",
    countries:['China'],
    paths:[[[41.80,109.00],[41.80,109.00]]]
  },

  { id:'barite', name:'Barite', region:'',
    fact:"China is one of the world's leading producers of barite. India and Morocco are also major producers. Barite is particularly important in drilling fluids used by the petroleum industry.",
    countries:['China'],
    paths:[[[30.50,104.00],[30.50,104.00]]]
  },

  { id:'talc', name:'Talc', region:'',
    fact:"China is one of the world's leading producers of talc. India and Brazil are among the other major producers. Talc is widely used in ceramics, paper, paints, plastics and cosmetics.",
    countries:['China'],
    paths:[[[41.80,123.40],[41.80,123.40]]]
  },

  { id:'kaolin', name:'Kaolin', region:'',
    fact:"The United States is a major producer of kaolin. China and Germany are among the other important producers. Georgia is the principal kaolin-producing state in the United States.",
    countries:['United States of America'],
    paths:[[[32.50,-83.50],[32.50,-83.50]]]
  },

  { id:'diatomite', name:'Diatomite', region:'',
    fact:"The United States is the world's leading producer of diatomite. China and Denmark are among the other major producers. Diatomite is widely used in filtration, fillers and absorbents.",
    countries:['United States of America'],
    paths:[[[40.00,-120.00],[40.00,-120.00]]]
  },

  { id:'bentonite', name:'Bentonite', region:'',
    fact:"The United States is one of the world's leading producers of bentonite. China and India are also major producers. Wyoming is especially famous for sodium bentonite deposits.",
    countries:['United States of America'],
    paths:[[[43.00,-107.50],[43.00,-107.50]]]
  },

  { id:'vermiculite', name:'Vermiculite', region:'',
    fact:"South Africa is a major producer of vermiculite. Brazil and the United States are among the other important producers. Vermiculite is widely used as a lightweight insulation and horticultural material.",
    countries:['South Africa'],
    paths:[[-25.50,30.50],[-25.50,30.50]]
  },

  { id:'perlite', name:'Perlite', region:'',
    fact:"Turkey is the world's leading producer of perlite. Greece and the United States are among the other major producers. Perlite is used extensively in construction, horticulture and insulation.",
    countries:['Turkey'],
    paths:[[[39.00,28.00],[39.00,28.00]]]
  },

  { id:'pumice', name:'Pumice', region:'',
    fact:"Turkey is one of the world's leading producers of pumice. Italy and Greece are among the other major producers. Pumice is associated with volcanic regions and is used in construction and abrasives.",
    countries:['Turkey'],
    paths:[[[38.70,34.70],[38.70,34.70]]]
  },

  { id:'boron', name:'Boron', region:'',
    fact:"Turkey dominates world production of boron minerals. The United States is another major producer and Argentina is among the important producers. Turkey's borate deposits are concentrated in western Anatolia.",
    countries:['Turkey'],
    paths:[[[39.50,29.00],[39.50,29.00]]]
  },

  { id:'beryllium', name:'Beryllium', region:'',
    fact:"The United States is the world's leading producer of beryllium. China and Brazil are among the countries with important production or resources. Utah is particularly important for U.S. beryllium production.",
    countries:['United States of America'],
    paths:[[[39.50,-110.50],[39.50,-110.50]]]
  },

  { id:'germanium', name:'Germanium', region:'',
    fact:"China is the world's leading producer of germanium. Russia and the United States are among the other important sources and processors. Germanium is mainly recovered as a by-product of zinc processing.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'gallium', name:'Gallium', region:'',
    fact:"China overwhelmingly dominates world primary gallium production. Japan and South Korea are important processors and producers of refined gallium. Gallium is important for semiconductors and LEDs.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'indium', name:'Indium', region:'',
    fact:"China is the world's leading producer of refined indium. South Korea and Japan are among the other major producers. Indium is mainly recovered as a by-product of zinc mining.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'bismuth', name:'Bismuth', region:'',
    fact:"China is the world's leading producer of refined bismuth. Vietnam and Laos are among the other countries associated with bismuth production. Bismuth is used in pharmaceuticals, alloys and low-melting materials.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'magnesium', name:'Magnesium', region:'',
    fact:"China overwhelmingly dominates world primary magnesium production. Russia and Israel are among the other important producers. China's production is concentrated in regions with abundant magnesite and energy resources.",
    countries:['China'],
    paths:[[[40.80,109.00],[40.80,109.00]]]
  },

  { id:'silicon', name:'Silicon', region:'',
    fact:"China is the world's dominant producer of silicon metal and ferrosilicon. Brazil and Norway are among the other important producers. Silicon is used in aluminium alloys, silicones and semiconductor industries.",
    countries:['China'],
    paths:[[[30.60,102.70],[30.60,102.70]]]
  },

  { id:'titanium', name:'Titanium', region:'',
    fact:"China is one of the world's leading producers of titanium mineral concentrates. Australia and South Africa are among the other major producers. Ilmenite and rutile are the principal titanium-bearing minerals.",
    countries:['China'],
    paths:[[[30.80,104.00],[30.80,104.00]]]
  },

  { id:'zirconium', name:'Zirconium', region:'',
    fact:"Australia is the world's leading producer of zirconium mineral concentrates. South Africa ranks second and China is among the other major producers. Zircon is the main commercial source of zirconium.",
    countries:['Australia'],
    paths:[[[30.00,121.00],[30.00,121.00]]]
  },

  { id:'iodine', name:'Iodine', region:'',
    fact:"Chile is the world's leading producer of iodine. Japan ranks second and the United States is among the other significant producers. Chilean iodine is mainly recovered from caliche deposits in the Atacama Desert.",
    countries:['Chile'],
    paths:[[[-23.60,-69.00],[-23.60,-69.00]]]
  },

  { id:'helium', name:'Helium', region:'',
    fact:"The United States remains one of the world's most important helium producers. Qatar and Algeria are among the other major suppliers. Helium is essential for cryogenics, MRI systems and specialized industrial applications.",
    countries:['United States of America'],
    paths:[[[36.00,-101.00],[36.00,-101.00]]]
  },

  { id:'sulfur', name:'Sulfur', region:'',
    fact:"China is the world's leading producer of sulfur. The United States and Russia are among the other major producers. Much sulfur is recovered as a by-product of petroleum and natural-gas processing.",
    countries:['China'],
    paths:[[[35.50,110.00],[35.50,110.00]]]
  },

  { id:'arsenic', name:'Arsenic', region:'',
    fact:"China is the world's leading producer of arsenic-containing mineral materials. Morocco and Peru are among the countries associated with important arsenic resources and production. Arsenic is commonly recovered as a by-product of metal mining.",
    countries:['China'],
    paths:[[[35.50,105.00],[35.50,105.00]]]
  },

  { id:'cadmium', name:'Cadmium', region:'',
    fact:"China is the world's leading producer of refined cadmium. South Korea and Japan are among the other major producers. Cadmium is primarily recovered as a by-product of zinc processing.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'selenium', name:'Selenium', region:'',
    fact:"China is one of the world's leading producers of refined selenium. Japan and Russia are among the other important producers. Selenium is commonly recovered during copper refining.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'tellurium', name:'Tellurium', region:'',
    fact:"China is the world's leading producer of refined tellurium. Japan and Russia are among the other important producers. Tellurium is mainly recovered as a by-product of copper refining.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'rhenium', name:'Rhenium', region:'',
    fact:"Chile is a leading producer of rhenium, recovered mainly as a by-product of molybdenum processing from copper deposits. The United States and Poland are among the other important producers.",
    countries:['Chile'],
    paths:[[[-27.30,-69.50],[-27.30,-69.50]]]
  },

  { id:'tantalum', name:'Tantalum', region:'',
    fact:"The Democratic Republic of the Congo and Rwanda are major sources of tantalum, with Rwanda among the world's leading producers. Brazil and Nigeria are also important producers.",
    countries:['Rwanda'],
    paths:[[[-2.00,29.90],[-2.00,29.90]]]
  },

  { id:'diamond_gemstone', name:'Gemstones', region:'',
    fact:"India is a major global center for cutting and polishing gemstones, while countries such as Sri Lanka and Thailand are important for colored gemstone production. Production rankings vary greatly by gemstone type.",
    countries:['India'],
    paths:[[[23.00,80.00],[23.00,80.00]]]
  },

  { id:'garnet', name:'Garnet', region:'',
    fact:"India is among the world's important garnet producers. The United States and Australia are also significant producers. Garnet is used as an abrasive and in water-jet cutting.",
    countries:['India'],
    paths:[[[10.50,78.00],[10.50,78.00]]]
  },

  { id:'asbestos', name:'Asbestos', region:'',
    fact:"Russia is the world's major producer of chrysotile asbestos. Kazakhstan and China are among the other countries associated with remaining production. Asbestos use is heavily restricted or banned in many countries because of health risks.",
    countries:['Russia'],
    paths:[[[60.00,60.00],[60.00,60.00]]]
  },

  { id:'feldspar', name:'Feldspar', region:'',
    fact:"Turkey is the world's leading producer of feldspar. India and China are among the other major producers. Feldspar is an important raw material for glass and ceramics.",
    countries:['Turkey'],
    paths:[[[38.50,28.50],[38.50,28.50]]]
  },

  { id:'diatomite', name:'Diatomite', region:'',
    fact:"The United States is the world's leading producer of diatomite. China and Denmark are among the other major producers. Diatomite is widely used for filtration and as an industrial absorbent.",
    countries:['United States of America'],
    paths:[[[40.00,-120.00],[40.00,-120.00]]]
  },

  { id:'saltpeter', name:'Nitrate', region:'',
    fact:"Chile is the world's historically important natural nitrate producer, particularly from the Atacama Desert. Synthetic nitrogen fertilizers now dominate global nitrogen supply, with China and other large fertilizer producers playing major roles.",
    countries:['Chile'],
    paths:[[[-23.50,-69.50],[-23.50,-69.50]]]
  },

  { id:'aluminum', name:'Aluminum', region:'',
    fact:"China is the world's leading producer of primary aluminum. India ranks second and Russia is among the other major producers. Aluminum production depends on alumina, which is produced from bauxite.",
    countries:['China'],
    paths:[[[30.60,104.00],[30.60,104.00]]]
  },

  { id:'steel', name:'Steel', region:'',
    fact:"China is by far the world's leading crude-steel producer. India ranks second and Japan third. China's steel industry is concentrated in major industrial regions including Hebei and the Yangtze River Delta.",
    countries:['China'],
    paths:[[[39.50,115.00],[39.50,115.00]]]
  },

  { id:'cement', name:'Cement', region:'',
    fact:"China is the world's largest cement producer. India ranks second and Vietnam is among the other major producers. China's enormous cement industry is closely linked with its construction sector.",
    countries:['China'],
    paths:[[[35.50,110.00],[35.50,110.00]]]
  }
