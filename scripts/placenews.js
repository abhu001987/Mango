...

{
  ...
  scope:'world',
  question:'Greenland',
  fact:"Greenland, which returned to the news after Denmark rejected renewed U.S. suggestions regarding its annexation, is an autonomous territory within the Kingdom of Denmark and the world's largest island.",
  answerNames:['Denmark'],
  paths: siteBox(72.0, -40.0, 8.0)
},

{
  ...
  name:'Durand Line',
  scope:'world',
  question:'The Durand Line',
  fact:"The Durand Line, which has witnessed repeated clashes between Afghan Taliban forces and Pakistani troops over border fencing, forms the disputed border between Afghanistan and Pakistan and was established in 1893.",
  answerNames:['Afghanistan','Pakistan'],
  paths: siteBox(33.5, 69.5, 5.0)
},

{
  ...
  scope:'world',
  question:'The Grand Ethiopian Renaissance Dam (GERD)',
  fact:"The Grand Ethiopian Renaissance Dam (GERD), which returned to the news after Ethiopia announced the completion of its construction, is located on the Blue Nile River in Ethiopia and is Africa's largest hydroelectric project.",
  answerNames:['Ethiopia'],
  paths: siteBox(11.2, 35.1, 1.5)
},

{
  ...
  scope:'world',
  question:'Eswatini',
  fact:"Eswatini, which was in the news after the United States deported a small number of criminals there, is a landlocked country in southern Africa and the continent's last absolute monarchy.",
  answerNames:['Eswatini'],
  paths: siteBox(-26.5, 31.5, 1.5)
},

{
  id:'nord_stream_pipeline',
  name:'Nord Stream Pipeline',
  scope:'world',
  question:'The Nord Stream Pipeline',
  fact:"The Nord Stream Pipeline, which returned to the news following renewed attention to pipeline leaks, runs beneath the Baltic Sea connecting Russia directly with Germany.",
  answerNames:['Russia','Germany'],
  paths: siteBox(55.0, 15.0, 4.5)
},

{
  ...
  scope:'world',
  question:'The Strait of Hormuz',
  fact:"The Strait of Hormuz, which remained in the news because of U.S.–Iran tensions and the Israel-Iran conflict, is the world's most important oil transit chokepoint between Iran and Oman.",
  answerNames:['Iran','Oman'],
  paths: siteBox(26.6, 56.3, 1.8)
},

{
  id:'netzarim_corridor',
  name:'Netzarim Corridor',
  scope:'world',
  question:'The Netzarim Corridor',
  fact:"The Netzarim Corridor, which featured prominently during Israeli military operations in Gaza, is a strategic corridor that divides the Gaza Strip into northern and southern sections.",
  answerNames:['Gaza Strip'],
  paths: siteBox(31.45, 34.43, 0.25)
},

{
  ...
  name:'Blue Line',
  scope:'world',
  question:'The Blue Line',
  fact:"The Blue Line, which has been in the news because of Israel-Lebanon border tensions, is the UN-recognised demarcation line separating Israel and Lebanon.",
  answerNames:['Israel','Lebanon'],
  paths: siteBox(33.2, 35.5, 1.0)
},

{
  ...
  scope:'world',
  question:'Al-Tanf Garrison',
  fact:"Al-Tanf Garrison, which gained attention during the Israel-Iran conflict, is a strategic U.S. military base located near the tri-border region of Syria, Iraq and Jordan.",
  answerNames:['Syria'],
  paths: siteBox(33.49, 38.62, 0.6)
},

{
  ...
  scope:'world',
  question:'The Bab-el-Mandeb Strait',
  fact:"The Bab-el-Mandeb Strait, which remained in the news after Houthi attacks disrupted global shipping, connects the Red Sea with the Gulf of Aden and the Indian Ocean.",
  answerNames:['Yemen','Djibouti'],
  paths: siteBox(12.6, 43.3, 1.2)
},

{
  id:'polar_silk_road',
  name:'Polar Silk Road',
  scope:'world',
  question:'The Polar Silk Road',
  fact:"The Polar Silk Road, which returned to the news amid debate over China's Arctic ambitions, is China's proposed Arctic shipping route under the Belt and Road Initiative.",
  answerNames:['Arctic Ocean'],
  paths: siteBox(78.0, 95.0, 12.0)
},

{
  ...
  fact:"The Red Sea, which remained in the news because of Houthi attacks on commercial vessels, is a vital shipping route linking the Indian Ocean to the Mediterranean through the Suez Canal.",
  answerNames:['Red Sea'],
  paths: siteBox(20.0, 38.0, 5.0)
},

{
  ...
  scope:'world',
  question:'The South China Sea',
  fact:"The South China Sea, frequently in the news because of China's territorial claims and military activities, carries nearly one-third of global maritime trade.",
  answerNames:['South China Sea'],
  paths: siteBox(13.0, 114.0, 7.0)
},

{
  ...
  scope:'world',
  question:'Ukraine',
  fact:"Ukraine, which continues to dominate global headlines because of the Russia-Ukraine war, is Europe's second-largest country and has a strategic coastline along the Black Sea.",
  answerNames:['Ukraine'],
  paths: siteBox(49.0, 31.0, 5.5)
},

{
  ...
  name:'Gaza Strip',
  scope:'world',
  question:'The Gaza Strip',
  fact:"The Gaza Strip, which has remained in the news because of the Israel-Hamas conflict and humanitarian crisis, is a densely populated Palestinian territory bordering Israel, Egypt and the Mediterranean Sea.",
  answerNames:['Palestine'],
  paths: siteBox(31.43, 34.36, 0.35)
},

{
  ...
  fact:"The Black Sea, which remains strategically important because of the Russia-Ukraine war, is bordered by six countries and serves as a major route for grain exports.",
  answerNames:['Black Sea'],
  paths: siteBox(43.0, 35.0, 5.5)
},

{
  ...
  name:'Sahel Region',
  scope:'world',
  question:'The Sahel Region',
  fact:"The Sahel Region, which has remained in the news because of military coups and Islamist insurgencies, is a semi-arid belt stretching across Africa south of the Sahara Desert.",
  answerNames:['Sahel'],
  paths: siteBox(15.0, 5.0, 13.0)
},

{
  ...
  scope:'world',
  question:'Antarctica',
  fact:"Antarctica, which returned to the news because of accelerating ice loss and record-low sea ice, contains nearly 70% of the world's freshwater locked in ice.",
  answerNames:['Antarctica'],
  paths: siteBox(-82.0, 0.0, 12.0)
},

{
  ...
  scope:'world',
  question:'Point Nemo',
  fact:"Point Nemo, which was in the news after Indian Navy women officers crossed it during a global circumnavigation, is the most remote point in the world's oceans and lies in the South Pacific.",
  answerNames:['South Pacific Ocean'],
  paths: siteBox(-48.88, -123.39, 3.0)
},

{
  ...
  scope:'world',
  question:'Kurdistan',
  fact:"Kurdistan, which was in the news after India sent humanitarian aid, is a mountainous region spread across Iraq, Turkey, Iran and Syria with a large Kurdish population.",
  answerNames:['Iraq','Turkey','Iran','Syria'],
  paths: siteBox(36.5, 44.5, 3.5)
},

{
  ...
  name:'North Sea',
  scope:'world',
  question:'The North Sea',
  fact:"The North Sea, which returned to the news because of energy security and offshore wind developments, lies between Great Britain and mainland Europe and is rich in oil and natural gas.",
  answerNames:['North Sea'],
  paths: siteBox(57.0, 3.0, 5.0)
},
{
  id:'mount_taranaki',
  name:'Mount Taranaki',
  scope:'world',
  question:'Mount Taranaki',
  fact:"Mount Taranaki, which recently made headlines after being granted legal personhood, is a dormant stratovolcano on New Zealand's North Island and is considered sacred by the Māori people.",
  answerNames:['New Zealand'],
  paths: siteBox(-39.296, 174.064, 1.0)
},

{
  ...
  name:'Darien Gap',
  scope:'world',
  question:'The Darien Gap',
  fact:"The Darien Gap, which has remained in the news because of illegal migration towards the United States, is a dense rainforest separating Colombia and Panama where the Pan-American Highway is interrupted.",
  answerNames:['Colombia','Panama'],
  paths: siteBox(8.4, -77.7, 1.8)
},

{
  ...
  name:'Baltic Nations',
  scope:'world',
  question:'The Baltic Nations',
  fact:"The Baltic Nations, which were in the news after disconnecting their electricity grid from Russia, comprise Estonia, Latvia and Lithuania on the eastern coast of the Baltic Sea.",
  answerNames:['Estonia','Latvia','Lithuania'],
  paths: siteBox(57.2, 24.7, 3.0)
},

{
  ...
  name:'Gulf of Eilat',
  scope:'world',
  question:'The Gulf of Eilat (Gulf of Aqaba)',
  fact:"The Gulf of Eilat, which returned to the news after coral ecosystems experienced an unusual cooling-related shutdown, is the northeastern arm of the Red Sea bordered by Egypt, Israel, Jordan and Saudi Arabia.",
  answerNames:['Red Sea'],
  paths: siteBox(29.5, 34.9, 1.2)
},

{
  ...
  name:'White Island',
  scope:'world',
  question:'White Island (Whakaari)',
  fact:"White Island, which was back in the news after New Zealand's High Court overturned eruption-related convictions, is one of the country's most active volcanoes located in the Bay of Plenty.",
  answerNames:['New Zealand'],
  paths: siteBox(-37.52, 177.18, 0.6)
},

{
  ...
  scope:'world',
  question:'Zambia',
  fact:"Zambia, which returned to the news after India secured exploration rights for copper and cobalt deposits, is a landlocked southern African country rich in critical minerals.",
  answerNames:['Zambia'],
  paths: siteBox(-13.5, 27.8, 3.0)
},

{
  ...
  scope:'world',
  question:'Nagorno-Karabakh',
  fact:"Nagorno-Karabakh, which continues to be in the news because of tensions between Armenia and Azerbaijan, is a mountainous region internationally recognised as part of Azerbaijan.",
  answerNames:['Azerbaijan'],
  paths: siteBox(39.83, 46.75, 1.4)
},

{
  ...
  name:'Kursk Region',
  scope:'world',
  question:'The Kursk Region',
  fact:"The Kursk Region, which returned to the news after Russian forces launched a major offensive against Ukrainian troops, is located in western Russia near the Ukrainian border.",
  answerNames:['Russia'],
  paths: siteBox(51.7, 36.2, 1.5)
},

{
  id:'strait_of_otranto',
  name:'Strait of Otranto',
  scope:'world',
  question:'The Strait of Otranto',
  fact:"The Strait of Otranto, which was highlighted because of its strategic importance in European geopolitics, connects the Adriatic Sea with the Ionian Sea between Italy and Albania.",
  answerNames:['Italy','Albania'],
  paths: siteBox(40.2, 19.2, 0.9)
},

{
  ...
  scope:'world',
  question:'Sanaa',
  fact:"Sanaa, which was in the news following airstrikes on its airport, is the capital of Yemen and one of the world's oldest continuously inhabited cities.",
  answerNames:['Yemen'],
  paths: siteBox(15.37, 44.21, 0.7)
},

{
  ...
  scope:'world',
  question:'Bamako',
  fact:"Bamako, which returned to the news because of pro-democracy protests, is the capital of Mali and is situated on the banks of the Niger River.",
  answerNames:['Mali'],
  paths: siteBox(12.64, -8.0, 0.8)
},

{
  ...
  scope:'world',
  question:'Shenzhen',
  fact:"Shenzhen, which has been in the news because of trade restrictions and AI cooperation, is China's first Special Economic Zone and is often called the country's Silicon Valley.",
  answerNames:['China'],
  paths: siteBox(22.54, 114.06, 0.9)
},

{
  ...
  name:'Mount Makalu',
  scope:'world',
  question:'Mount Makalu',
  fact:"Mount Makalu, which returned to the news after an ITBP expedition successfully scaled it, is the world's fifth-highest mountain located on the Nepal-China border.",
  answerNames:['Nepal','China'],
  paths: siteBox(27.89, 87.09, 0.7)
},

{
  id:'al_udeid_air_base',
  name:'Al Udeid Air Base',
  scope:'world',
  question:'Al Udeid Air Base',
  fact:"Al Udeid Air Base, which remained in the news during the Iran-Israel conflict, is the largest U.S. military base in the Middle East and is located in Qatar.",
  answerNames:['Qatar'],
  paths: siteBox(25.12, 51.31, 0.6)
},

{
  ...
  scope:'world',
  question:'Kananaskis',
  fact:"Kananaskis, which was in the news after hosting the G7 Summit, is a mountainous region in Alberta, Canada, located near Banff National Park.",
  answerNames:['Canada'],
  paths: siteBox(50.93, -115.13, 1.0)
},

{
  ...
  name:'Port of Haifa',
  scope:'world',
  question:'The Port of Haifa',
  fact:"The Port of Haifa, which returned to the news after the Adani Group acquired a majority stake, is Israel's largest Mediterranean port and an important hub in the India-Middle East-Europe Corridor (IMEC).",
  answerNames:['Israel'],
  paths: siteBox(32.82, 35.0, 0.4)
},

{
  ...
  scope:'world',
  question:'Qom',
  fact:"Qom, which remained in the news because of the nearby Fordow nuclear facility, is one of Iran's holiest cities and an important centre of Shia Islamic scholarship.",
  answerNames:['Iran'],
  paths: siteBox(34.64, 50.88, 0.7)
},

{
  ...
  scope:'world',
  question:'Qingdao',
  fact:"Qingdao, which was in the news after hosting the SCO Defence Ministers' Meeting, is a major Chinese port city on the Yellow Sea and an important naval base.",
  answerNames:['China'],
  paths: siteBox(36.07, 120.38, 0.8)
},
{
  id:'ghana',
  name:'Ghana',
  scope:'world',
  question:'Ghana',
  fact:"Ghana, which was in the news after Prime Minister Narendra Modi visited the country, is a West African nation on the Gulf of Guinea and one of the world's leading cocoa producers.",
  answerNames:['Ghana'],
  paths: siteBox(7.95, -1.02, 3.0)
},

{
  ...
  scope:'world',
  question:'Suwayda',
  fact:"Suwayda, which returned to the news because of Bedouin-Druze clashes and ethnic violence, is a predominantly Druze province located in southern Syria.",
  answerNames:['Syria'],
  paths: siteBox(32.71, 36.57, 0.8)
},

{
  ...
  scope:'world',
  question:'Tuvalu',
  fact:"Tuvalu, which was in the news after launching the world's first climate visa programme, is a low-lying Pacific island nation highly vulnerable to rising sea levels.",
  answerNames:['Tuvalu'],
  paths: siteBox(-8.52, 179.2, 1.5)
},

{
  ...
  scope:'world',
  question:'Lake Urmia',
  fact:"Lake Urmia, which returned to the news because of historic drought and environmental degradation, is one of the world's largest salt lakes and is located in northwestern Iran.",
  answerNames:['Iran'],
  paths: siteBox(37.7, 45.5, 1.0)
},

{
  id:'krasheninnikov_volcano',
  name:'Krasheninnikov Volcano',
  scope:'world',
  question:'Krasheninnikov Volcano',
  fact:"Krasheninnikov Volcano, which made headlines after erupting for the first time in about 500 years, is located on Russia's Kamchatka Peninsula within the Pacific Ring of Fire.",
  answerNames:['Russia'],
  paths: siteBox(54.0, 160.6, 1.2)
},

{
  ...
  fact:"Machu Picchu, which was recently in the news after tourists were evacuated following disaster-related disruptions, is a UNESCO World Heritage Inca citadel in the Andes of Peru.",
  answerNames:['Peru'],
  paths: siteBox(-13.1631, -72.5450, 0.8)
},

{
  ...
  name:'Luzon Strait',
  scope:'world',
  question:'The Luzon Strait',
  fact:"The Luzon Strait, which was in the news because of Super Typhoon Ragasa and its strategic importance, connects the South China Sea with the Philippine Sea between Taiwan and the Philippines.",
  answerNames:['Taiwan','Philippines'],
  paths: siteBox(20.8, 121.5, 1.6)
},

{
  ...
  scope:'world',
  question:'Scarborough Shoal (Huangyan)',
  fact:"Scarborough Shoal, which returned to the news after China declared it a national reserve, is a disputed coral shoal in the South China Sea claimed by both China and the Philippines.",
  answerNames:['South China Sea'],
  paths: siteBox(15.2, 117.8, 0.8)
},

{
  ...
  name:'Darfur',
  scope:'world',
  question:'The Darfur Region',
  fact:"The Darfur Region, which remained in the news because of conflict and a deadly landslide, is located in western Sudan and has experienced a prolonged humanitarian crisis.",
  answerNames:['Sudan'],
  paths: siteBox(13.5, 24.5, 3.0)
},

{
  ...
  scope:'world',
  question:'Benin',
  fact:"Benin, which was in the news because of diplomatic and cultural engagements, is a West African country on the Gulf of Guinea and was formerly known as Dahomey.",
  answerNames:['Benin'],
  paths: siteBox(9.5, 2.3, 2.0)
},

{
  ...
  scope:'world',
  question:'The Senkaku Islands',
  fact:"The Senkaku Islands, which continue to feature in the news because of territorial disputes, are administered by Japan but are also claimed by China and Taiwan.",
  answerNames:['Japan'],
  paths: siteBox(25.75, 123.5, 0.7)
},

{
  ...
  scope:'world',
  question:'Madagascar',
  fact:"Madagascar, which returned to the news because of climate vulnerability and biodiversity conservation, is the world's fourth-largest island and is famous for its unique wildlife.",
  answerNames:['Madagascar'],
  paths: siteBox(-19.4, 46.7, 4.0)
},

{
  ...
  scope:'world',
  question:'Sharm el-Sheikh',
  fact:"Sharm el-Sheikh, which remained in the news because of global climate diplomacy after COP27, is an Egyptian resort city located on the Red Sea coast of the Sinai Peninsula.",
  answerNames:['Egypt'],
  paths: siteBox(27.91, 34.33, 0.7)
},

{
  ...
  name:'Port of Pasni',
  scope:'world',
  question:'The Port of Pasni',
  fact:"The Port of Pasni, which returned to the news because of discussions on CPEC and Arabian Sea security, is located on Pakistan's Makran Coast near Gwadar.",
  answerNames:['Pakistan'],
  paths: siteBox(25.26, 63.47, 0.7)
},

{
  ...
  scope:'world',
  question:'Bagram Air Base',
  fact:"Bagram Air Base, which was in the news because of Afghanistan's security situation after the U.S. withdrawal, is a former major U.S. military base located north of Kabul.",
  answerNames:['Afghanistan'],
  paths: siteBox(34.95, 69.27, 0.8)
},

{
  ...
  scope:'world',
  question:'Sir Bani Yas Island',
  fact:"Sir Bani Yas Island, which was in the news because of diplomatic engagements and conservation initiatives, is a protected island and wildlife reserve in Abu Dhabi, UAE.",
  answerNames:['United Arab Emirates'],
  paths: siteBox(24.28, 52.61, 0.7)
},

{
  id:'dardanelles_strait',
  name:'Dardanelles Strait',
  scope:'world',
  question:'The Dardanelles Strait',
  fact:"The Dardanelles Strait, which returned to the news because of Black Sea geopolitics, connects the Aegean Sea with the Sea of Marmara and is controlled by Türkiye.",
  answerNames:['Türkiye'],
  paths: siteBox(40.2, 26.4, 0.9)
},

{
  id:'gola_tiwai_complex',
  name:'Gola-Tiwai Complex',
  scope:'world',
  question:'The Gola-Tiwai Complex',
  fact:"The Gola-Tiwai Complex, which made headlines after receiving UNESCO World Heritage recognition, is a tropical rainforest in Sierra Leone known for its rich biodiversity.",
  answerNames:['Sierra Leone'],
  paths: siteBox(7.8, -11.3, 0.9)
},

{
  ...
  scope:'world',
  question:'Croatia',
  fact:"Croatia, which was in the news following the Indian Prime Minister's diplomatic visit, is a Central European country with a long coastline along the Adriatic Sea.",
  answerNames:['Croatia'],
  paths: siteBox(45.2, 16.4, 2.0)
},

{
  ...
  scope:'world',
  question:'Bougainville Island',
  fact:"Bougainville Island, which returned to the news because of its push for independence from Papua New Guinea, is a resource-rich island in the Solomon Sea.",
  answerNames:['Papua New Guinea'],
  paths: siteBox(-6.2, 155.5, 1.2)
},

{
  ...
  name:'Tokara Islands',
  scope:'world',
  question:'The Tokara Islands',
  fact:"The Tokara Islands, which made headlines after more than 1,000 earthquakes struck the region, are a volcanic island chain located in southern Japan.",
  answerNames:['Japan'],
  paths: siteBox(29.6, 129.5, 1.2)
},

{
  ...
  name:'Kerch Strait',
  scope:'world',
  question:'The Kerch Strait',
  fact:"The Kerch Strait, which was in the news after Ukraine claimed to have targeted the Crimean Bridge, connects the Black Sea with the Sea of Azov between Crimea and Russia.",
  answerNames:['Russia','Ukraine'],
  paths: siteBox(45.3, 36.5, 0.9)
},

{
  ...
  scope:'world',
  question:'The Chagos Archipelago',
  fact:"The Chagos Archipelago, which returned to the news after the UK agreed to transfer sovereignty to Mauritius while leasing back Diego Garcia, is a strategically important island group in the central Indian Ocean.",
  answerNames:['Mauritius'],
  paths: siteBox(-6.0, 72.5, 2.5)
}
