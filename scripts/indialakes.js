/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'lake-navigator-india';
...
/* ============================================================
   ...
   the Heritage Navigator (nearest-edge / inside-polygon) works unchanged.
...
const ROUNDS = [
  ...
  { id:'dal_lake', name:'Dal Lake', region:'',
    fact:"A famous urban lake in Srinagar known for its houseboats, shikaras and floating gardens (raad). It has long been a centre of Kashmiri trade and tourism, fed by the Telbal Nallah.",
    states:['Jammu and Kashmir'],
    paths: siteBox(34.1200, 74.8700)
  },

  { id:'wular_lake', name:'Wular Lake', region:'',
    fact:"One of the largest freshwater lakes in Asia and the largest in India, formed by a tectonic depression and fed mainly by the Jhelum River. Designated a Ramsar wetland of international importance in 1990.",
    states:['Jammu and Kashmir'],
    paths: siteBox(34.3667, 74.6000)
  },

  { id:'chilika_lake', name:'Chilika Lake', region:'',
    fact:"The largest coastal lagoon in India and one of the largest in the world, opening into the Bay of Bengal. It was the first wetland in India to be designated a Ramsar site, in 1981, and is a major wintering ground for migratory birds.",
    states:['Odisha'],
    paths: siteBox(19.7000, 85.3200)
  },

  { id:'vembanad_lake', name:'Vembanad Lake', region:'',
    fact:"The longest lake in India, stretching through Alappuzha, Kottayam and Ernakulam districts and forming the heart of the Kerala backwaters. The Vembanad-Kol wetland was listed as a Ramsar site in 2002.",
    states:['Kerala'],
    paths: siteBox(9.6000, 76.4000)
  },

  { id:'pulicat_lake', name:'Pulicat Lake', region:'',
    fact:"India's second-largest brackish-water lagoon after Chilika, straddling the Andhra Pradesh–Tamil Nadu border. It hosts the Sriharikota barrier island and is an important flamingo habitat.",
    states:['Andhra Pradesh', 'Tamil Nadu'],
    paths: siteBox(13.6667, 80.1667)
  },

  { id:'sambhar_lake', name:'Sambhar Salt Lake', region:'',
    fact:"India's largest inland salt lake, located between Jaipur and Ajmer. It has been a major source of salt production since Chauhan-era times and is a Ramsar-designated wintering site for flamingos.",
    states:['Rajasthan'],
    paths: siteBox(26.9167, 75.0833)
  },

  { id:'loktak_lake', name:'Loktak Lake', region:'',
    fact:"The largest freshwater lake in Northeast India, famous for its floating phumdis (masses of vegetation and soil). It hosts Keibul Lamjao, the world's only floating national park, home to the endangered sangai deer.",
    states:['Manipur'],
    paths: siteBox(24.5500, 93.7833)
  },

  { id:'nainital_lake', name:'Nainital Lake', region:'',
    fact:"A crescent-shaped natural freshwater lake in the Kumaon Himalayas, around which the hill town of Nainital developed under British colonial administration in the 19th century.",
    states:['Uttarakhand'],
    paths: siteBox(29.3900, 79.4600)
  },

  { id:'kolleru_lake', name:'Kolleru Lake', region:'',
    fact:"One of the largest freshwater shallow lakes in India, lying between the Krishna and Godavari river deltas. Declared a wildlife sanctuary and a Ramsar site, it is an important habitat for resident and migratory birds.",
    states:['Andhra Pradesh'],
    paths: siteBox(16.6167, 81.2167)
  },

  { id:'renuka_lake', name:'Renuka Lake', region:'',
    fact:"The largest lake in Himachal Pradesh, considered sacred and associated with the goddess Renuka in Hindu mythology. It is a Ramsar site and surrounded by the Renuka Wildlife Sanctuary.",
    states:['Himachal Pradesh'],
    paths: siteBox(30.6000, 77.4500)
  },

  { id:'pushkar_lake', name:'Pushkar Lake', region:'',
    fact:"A sacred lake in the Aravalli Range, ringed by ghats and temples including the Brahma Temple, one of the few in India dedicated to the creator deity. It draws large numbers of Hindu pilgrims, especially during Kartik Purnima.",
    states:['Rajasthan'],
    paths: siteBox(26.4900, 74.5500)
  },

  { id:'hussain_sagar', name:'Hussain Sagar', region:'',
    fact:"A large heart-shaped, man-made lake built in 1563 by Hussain Shah Wali on a tributary of the Musi River, connecting the twin cities of Hyderabad and Secunderabad. It is known for its large monolithic Buddha statue at its centre.",
    states:['Telangana'],
    paths: siteBox(17.4239, 78.4738)
  },
  { id:'pangong_tso', name:'Pangong Tso', region:'',
  fact:"A high-altitude endorheic lake shared by India and China, famous for its changing shades of blue. About one-third of the lake lies in India.",
  states:['Ladakh'],
  paths: siteBox(33.73, 78.90)
},

{ id:'tso_moriri', name:'Tso Moriri', region:'',
  fact:"A high-altitude freshwater lake in the Changthang Plateau, designated a Ramsar Site and an important breeding ground for migratory birds.",
  states:['Ladakh'],
  paths: siteBox(32.90, 78.30)
},

{ id:'tso_kar', name:'Tso Kar', region:'',
  fact:"A high-altitude salt lake in the Rupshu Plateau, known for its rich birdlife and inclusion within the Changthang Ramsar Site.",
  states:['Ladakh'],
  paths: siteBox(33.30, 78.00)
},

{ id:'surinsar_lake', name:'Surinsar Lake', region:'',
  fact:"A freshwater lake near Jammu, linked in local tradition with the nearby Mansar Lake and protected as a Ramsar Site.",
  states:['Jammu and Kashmir'],
  paths: siteBox(32.77, 75.02)
},

{ id:'mansar_lake', name:'Mansar Lake', region:'',
  fact:"A sacred freshwater lake surrounded by temples and forests, designated a Ramsar Site together with Surinsar Lake.",
  states:['Jammu and Kashmir'],
  paths: siteBox(32.70, 75.15)
},

{ id:'debar_lake', name:'Dhebar (Jaisamand) Lake', region:'',
  fact:"One of the largest artificial freshwater lakes in Asia, created in 1685 by Maharana Jai Singh through the construction of the Jaisamand Dam.",
  states:['Rajasthan'],
  paths: siteBox(24.28, 73.97)
},

{ id:'fateh_sagar', name:'Fateh Sagar Lake', region:'',
  fact:"An artificial lake in Udaipur built in the 17th century and one of the city's famous interconnected lakes.",
  states:['Rajasthan'],
  paths: siteBox(24.60, 73.68)
},

{ id:'pichola_lake', name:'Lake Pichola', region:'',
  fact:"A historic artificial freshwater lake in Udaipur, created in 1362 and renowned for the Lake Palace and Jag Mandir situated within it.",
  states:['Rajasthan'],
  paths: siteBox(24.58, 73.68)
},

{ id:'nakki_lake', name:'Nakki Lake', region:'',
  fact:"A natural lake at Mount Abu surrounded by hills and associated with legends that it was dug by the gods using their nails.",
  states:['Rajasthan'],
  paths: siteBox(24.60, 72.71)
},

{ id:'ashtamudi_lake', name:'Ashtamudi Lake', region:'',
  fact:"A palm-shaped estuarine lake in Kerala with eight branches, designated a Ramsar Site and forming part of the state's backwater network.",
  states:['Kerala'],
  paths: siteBox(8.99, 76.60)
},

{ id:'sasthamkotta_lake', name:'Sasthamkotta Lake', region:'',
  fact:"The largest freshwater lake in Kerala and the primary source of drinking water for Kollam district.",
  states:['Kerala'],
  paths: siteBox(9.03, 76.63)
},

{ id:'harike_lake', name:'Harike Wetland', region:'',
  fact:"The largest wetland in northern India, formed at the confluence of the Beas and Sutlej rivers and designated a Ramsar Site.",
  states:['Punjab'],
  paths: siteBox(31.17, 74.93)
},

{ id:'kanwar_lake', name:'Kanwar Lake', region:'',
  fact:"Also known as Kabar Tal, it is Asia's largest freshwater oxbow lake and a Ramsar Site important for migratory birds.",
  states:['Bihar'],
  paths: siteBox(25.58, 86.15)
},

{ id:'rudrasagar_lake', name:'Rudrasagar Lake', region:'',
  fact:"A freshwater lake in Tripura famous for the Neermahal palace situated in its centre.",
  states:['Tripura'],
  paths: siteBox(23.53, 91.30)
},

{ id:'deepor_beel', name:'Deepor Beel', region:'',
  fact:"A permanent freshwater lake and Ramsar Site on the outskirts of Guwahati, serving as an important wetland for migratory birds.",
  states:['Assam'],
  paths: siteBox(26.10, 91.65)
},

{ id:'lonar_lake', name:'Lonar Lake', region:'',
  fact:"A saline lake formed by a meteorite impact in basalt rock around 52,000 years ago, making it one of the world's few hypervelocity impact craters.",
  states:['Maharashtra'],
  paths: siteBox(19.98, 76.51)
}
...
/* ---------------- Indian states overlay (for round-result highlighting) ----------------
   Highlights just the STATE a lake lies in, not the whole country — more useful for
...
/* Is the guess anywhere inside the lake's actual state? */
...
function nearestOnPaths(p, paths){
  // Inside the lake's marker box? Full credit — distance 0.
...
function lockGuess(){
  ...
  // If you're outside the lake's marker box but inside the state the lake
  ...
  // Fly the map to fit both the guess and the real lake, so the
...
async function endGame(){
  ...
  let msg;
  if(avg >= 85) msg = "Master of Indian lake geography. UPSC map-based questions won't stand a chance.";
  else if(avg >= 65) msg = "Sharp sense of the map — a seasoned reading of India's major lakes and wetlands.";
...
async function ensureChallengeLinkReady(){
  ...
  try{
    ...
    const msg = `🏞️ I just charted the Lake Navigator (India) and scored ${currentAvgScore}%. Think you can pin the lakes closer? Take the same targets: ${link}`;
