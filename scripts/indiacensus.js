...
const ROUNDS = [
  ...
  { id:'highest_population', name:'Highest Population',
    question:'Which state had the highest population according to Census 2011?',
    fact:"Uttar Pradesh was India's most populous state in Census 2011, home to just over 199 million people — more than the population of Brazil.",
    states:['Uttar Pradesh'],
    paths: siteBox(26.85, 80.91, 0.55)
  },

  { id:'highest_density', name:'Highest Population Density',
    question:'Which state had the highest population density according to Census 2011?',
    fact:"Bihar recorded India's highest population density among states in Census 2011, at about 1,102 persons per square kilometre.",
    states:['Bihar'],
    paths: siteBox(25.10, 85.60, 0.45)
  },

  { id:'highest_literacy', name:'Highest Literacy Rate',
    question:'Which state had the highest literacy rate according to Census 2011?',
    fact:"Kerala recorded India's highest literacy rate in Census 2011, at roughly 94% — extending its long-standing lead in education indicators.",
    states:['Kerala'],
    paths: siteBox(10.85, 76.27, 0.35)
  },

  { id:'highest_sex_ratio', name:'Highest Sex Ratio',
    question:'Which state had the highest sex ratio according to Census 2011?',
    fact:"Kerala recorded India's highest sex ratio among states in Census 2011, with 1,084 females for every 1,000 males.",
    states:['Kerala'],
    paths: siteBox(10.30, 76.55, 0.30)
  },

  { id:'highest_growth_rate', name:'Highest Decadal Growth',
    question:'Which state recorded the highest population growth rate during 2001–2011?',
    fact:"Meghalaya recorded India's highest decadal population growth rate among states between 2001 and 2011, at around 27.8%.",
    states:['Meghalaya'],
    paths: siteBox(25.47, 91.37, 0.35)
  },

  { id:'lowest_population', name:'Lowest Population',
    question:'Which state had the lowest population according to Census 2011?',
    fact:"Sikkim was India's least populous state in Census 2011, with a population of just over 6 lakh.",
    states:['Sikkim'],
    paths: siteBox(27.53, 88.51, 0.22)
  },

  { id:'lowest_density', name:'Lowest Population Density',
    question:'Which state had the lowest population density according to Census 2011?',
    fact:"Arunachal Pradesh recorded India's lowest population density among states in Census 2011, at only around 17 persons per square kilometre.",
    states:['Arunachal Pradesh'],
    paths: siteBox(28.10, 94.00, 0.50)
  },

  { id:'lowest_literacy', name:'Lowest Literacy Rate',
    question:'Which state had the lowest literacy rate according to Census 2011?',
    fact:"Bihar recorded India's lowest literacy rate among states in Census 2011, at around 61.8%.",
    states:['Bihar'],
    paths: siteBox(25.60, 86.20, 0.45)
  },

  { id:'lowest_sex_ratio', name:'Lowest Sex Ratio',
    question:'Which state had the lowest sex ratio according to Census 2011?',
    fact:"Haryana recorded India's lowest sex ratio among states in Census 2011, with just 879 females for every 1,000 males.",
    states:['Haryana'],
    paths: siteBox(29.06, 76.09, 0.32)
  },

  { id:'largest_area', name:'Largest State by Area',
    question:'Which state has the largest area in India?',
    fact:"Rajasthan is India's largest state by area, covering roughly 3.42 lakh square kilometres — about a tenth of the country's total land area.",
    states:['Rajasthan'],
    paths: siteBox(26.50, 73.80, 0.60)
  },

  { id:'smallest_area', name:'Smallest State by Area',
    question:'Which state has the smallest area in India?',
    fact:"Goa is India's smallest state by area, covering just around 3,700 square kilometres.",
    states:['Goa'],
    paths: siteBox(15.30, 74.12, 0.20)
  },

  { id:'negative_growth', name:'A Rare Negative Growth',
    question:'Which state recorded a negative population growth rate during 2001–2011 — a rare occurrence in India?',
    fact:"Nagaland recorded a negative decadal population growth rate between 2001 and 2011 (around -0.47%), an unusual outlier among Indian states.",
    states:['Nagaland'],
    paths: siteBox(26.15, 94.56, 0.30)
  },
  { id:'second_highest_population', name:'Second Highest Population',
  question:'Which state had the second highest population according to Census 2011?',
  fact:"Maharashtra was India's second most populous state in Census 2011, with over 11.2 crore people.",
  states:['Maharashtra'],
  paths: siteBox(19.50, 75.30, 0.55)
},

{ id:'third_highest_population', name:'Third Highest Population',
  question:'Which state had the third highest population according to Census 2011?',
  fact:"Bihar was India's third most populous state in Census 2011.",
  states:['Bihar'],
  paths: siteBox(25.60, 85.80, 0.45)
},

{ id:'second_highest_density', name:'Second Highest Population Density',
  question:'Which state had the second highest population density according to Census 2011?',
  fact:"West Bengal recorded the second highest population density among states in Census 2011.",
  states:['West Bengal'],
  paths: siteBox(23.50, 87.80, 0.40)
},

{ id:'second_highest_literacy', name:'Second Highest Literacy Rate',
  question:'Which state had the second highest literacy rate according to Census 2011?',
  fact:"Mizoram recorded the second highest literacy rate among states in Census 2011.",
  states:['Mizoram'],
  paths: siteBox(23.30, 92.80, 0.25)
},

{ id:'second_lowest_literacy', name:'Second Lowest Literacy Rate',
  question:'Which state had the second lowest literacy rate according to Census 2011?',
  fact:"Arunachal Pradesh recorded the second lowest literacy rate among states in Census 2011.",
  states:['Arunachal Pradesh'],
  paths: siteBox(28.20, 94.50, 0.45)
},

{ id:'second_highest_sex_ratio', name:'Second Highest Sex Ratio',
  question:'Which state had the second highest sex ratio according to Census 2011?',
  fact:"Tamil Nadu recorded the second highest sex ratio among Indian states in Census 2011.",
  states:['Tamil Nadu'],
  paths: siteBox(11.10, 78.70, 0.45)
},

{ id:'lowest_growth', name:'Lowest Decadal Growth',
  question:'Which state recorded the lowest decadal population growth during 2001–2011?',
  fact:"Nagaland recorded the lowest decadal population growth due to negative growth.",
  states:['Nagaland'],
  paths: siteBox(26.15,94.56,0.30)
},

{ id:'highest_male_literacy', name:'Highest Male Literacy',
  question:'Which state had the highest male literacy rate according to Census 2011?',
  fact:"Kerala recorded the highest male literacy rate in Census 2011.",
  states:['Kerala'],
  paths: siteBox(10.60,76.40,0.35)
},

{ id:'highest_female_literacy', name:'Highest Female Literacy',
  question:'Which state had the highest female literacy rate according to Census 2011?',
  fact:"Kerala recorded the highest female literacy rate in Census 2011.",
  states:['Kerala'],
  paths: siteBox(10.60,76.40,0.35)
},

{ id:'lowest_female_literacy', name:'Lowest Female Literacy',
  question:'Which state had the lowest female literacy rate according to Census 2011?',
  fact:"Rajasthan recorded the lowest female literacy rate among states in Census 2011.",
  states:['Rajasthan'],
  paths: siteBox(26.50,73.80,0.60)
},

{ id:'highest_child_sex_ratio', name:'Highest Child Sex Ratio',
  question:'Which state recorded the highest child sex ratio (0–6 years) in Census 2011?',
  fact:"Arunachal Pradesh recorded the highest child sex ratio among states in Census 2011.",
  states:['Arunachal Pradesh'],
  paths: siteBox(28.10,94.00,0.50)
},

{ id:'lowest_child_sex_ratio', name:'Lowest Child Sex Ratio',
  question:'Which state recorded the lowest child sex ratio (0–6 years) in Census 2011?',
  fact:"Haryana recorded the lowest child sex ratio in Census 2011.",
  states:['Haryana'],
  paths: siteBox(29.10,76.10,0.32)
},

{ id:'highest_urban_population', name:'Highest Urban Population',
  question:'Which state had the highest urban population according to Census 2011?',
  fact:"Maharashtra had the highest urban population in Census 2011.",
  states:['Maharashtra'],
  paths: siteBox(19.50,75.30,0.55)
},

{ id:'highest_rural_population', name:'Highest Rural Population',
  question:'Which state had the highest rural population according to Census 2011?',
  fact:"Uttar Pradesh had the highest rural population in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_urbanisation', name:'Highest Urbanisation',
  question:'Which state had the highest percentage of urban population according to Census 2011?',
  fact:"Goa was the most urbanised major state in Census 2011.",
  states:['Goa'],
  paths: siteBox(15.30,74.12,0.20)
},

{ id:'lowest_urbanisation', name:'Lowest Urbanisation',
  question:'Which state had the lowest percentage of urban population according to Census 2011?',
  fact:"Himachal Pradesh had the lowest urbanisation among Indian states.",
  states:['Himachal Pradesh'],
  paths: siteBox(31.80,77.20,0.40)
},

{ id:'highest_sc_population', name:'Highest Scheduled Caste Population',
  question:'Which state had the highest Scheduled Caste population according to Census 2011?',
  fact:"Uttar Pradesh had the highest Scheduled Caste population in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_st_population', name:'Highest Scheduled Tribe Population',
  question:'Which state had the highest Scheduled Tribe population according to Census 2011?',
  fact:"Madhya Pradesh had the highest Scheduled Tribe population in India.",
  states:['Madhya Pradesh'],
  paths: siteBox(23.50,78.50,0.55)
},

{ id:'highest_sc_percentage', name:'Highest SC Percentage',
  question:'Which state had the highest percentage of Scheduled Caste population according to Census 2011?',
  fact:"Punjab had the highest proportion of Scheduled Castes among all states.",
  states:['Punjab'],
  paths: siteBox(31.00,75.40,0.35)
},

{ id:'highest_st_percentage', name:'Highest ST Percentage',
  question:'Which state had the highest percentage of Scheduled Tribe population according to Census 2011?',
  fact:"Mizoram had the highest proportion of Scheduled Tribe population.",
  states:['Mizoram'],
  paths: siteBox(23.30,92.80,0.25)
},

{ id:'highest_work_participation', name:'Highest Work Participation',
  question:'Which state had the highest work participation rate according to Census 2011?',
  fact:"Himachal Pradesh recorded the highest work participation rate among major states.",
  states:['Himachal Pradesh'],
  paths: siteBox(31.80,77.20,0.40)
},

{ id:'lowest_work_participation', name:'Lowest Work Participation',
  question:'Which state had the lowest work participation rate according to Census 2011?',
  fact:"Bihar recorded the lowest work participation rate among states.",
  states:['Bihar'],
  paths: siteBox(25.60,85.80,0.45)
},

{ id:'highest_forest_dwelling_st', name:'Largest Tribal Population',
  question:'Which state had the largest tribal population according to Census 2011?',
  fact:"Madhya Pradesh had the largest Scheduled Tribe population in absolute numbers.",
  states:['Madhya Pradesh'],
  paths: siteBox(23.50,78.50,0.55)
},

{ id:'most_districts', name:'Most Districts',
  question:'Which state had the largest number of districts during Census 2011?',
  fact:"Uttar Pradesh had the largest number of districts at the time of Census 2011.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'least_districts', name:'Least Districts',
  question:'Which state had only one district during Census 2011?',
  fact:"Goa had only two districts, the fewest among Indian states.",
  states:['Goa'],
  paths: siteBox(15.30,74.12,0.20)
},

{ id:'highest_households', name:'Highest Number of Households',
  question:'Which state had the highest number of households according to Census 2011?',
  fact:"Uttar Pradesh had the highest number of households in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_female_population', name:'Highest Female Population',
  question:'Which state had the highest female population according to Census 2011?',
  fact:"Uttar Pradesh had the highest female population in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_male_population', name:'Highest Male Population',
  question:'Which state had the highest male population according to Census 2011?',
  fact:"Uttar Pradesh had the highest male population in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_children_population', name:'Largest Child Population',
  question:'Which state had the largest child population (0–6 years) according to Census 2011?',
  fact:"Uttar Pradesh had the largest child population in Census 2011.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_slum_population', name:'Highest Slum Population',
  question:'Which state had the highest slum population according to Census 2011?',
  fact:"Maharashtra had the highest slum population in India.",
  states:['Maharashtra'],
  paths: siteBox(19.50,75.30,0.55)
},

{ id:'highest_migration', name:'Highest Interstate Migration',
  question:'Which state attracted the highest number of interstate migrants according to Census 2011?',
  fact:"Maharashtra attracted the highest number of interstate migrants.",
  states:['Maharashtra'],
  paths: siteBox(19.50,75.30,0.55)
},

{ id:'highest_household_size', name:'Highest Household Size',
  question:'Which state had the highest average household size according to Census 2011?',
  fact:"Jammu and Kashmir recorded the highest average household size.",
  states:['Jammu & Kashmir'],
  paths: siteBox(33.50,75.20,0.50)
},

{ id:'lowest_household_size', name:'Lowest Household Size',
  question:'Which state had the lowest average household size according to Census 2011?',
  fact:"Tamil Nadu recorded the lowest average household size.",
  states:['Tamil Nadu'],
  paths: siteBox(11.10,78.70,0.45)
},

{ id:'highest_married_population', name:'Highest Married Population',
  question:'Which state had the highest number of married persons according to Census 2011?',
  fact:"Uttar Pradesh had the highest number of married persons due to its large population.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_disabled_population', name:'Highest Disabled Population',
  question:'Which state had the highest number of persons with disabilities according to Census 2011?',
  fact:"Uttar Pradesh recorded the highest number of persons with disabilities.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_hindu_population', name:'Highest Hindu Population',
  question:'Which state had the highest Hindu population according to Census 2011?',
  fact:"Uttar Pradesh had the highest Hindu population in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_muslim_population', name:'Highest Muslim Population',
  question:'Which state had the highest Muslim population according to Census 2011?',
  fact:"Uttar Pradesh had the highest Muslim population in India.",
  states:['Uttar Pradesh'],
  paths: siteBox(26.85,80.91,0.55)
},

{ id:'highest_christian_population', name:'Highest Christian Population',
  question:'Which state had the highest Christian population according to Census 2011?',
  fact:"Kerala had the highest Christian population among Indian states.",
  states:['Kerala'],
  paths: siteBox(10.60,76.40,0.35)
},
{
  id: 'longest_coastline',
  name: 'Longest Coastline',
  question: 'Which state has the longest coastline in India?',
  fact: "Gujarat has the longest coastline among Indian states, stretching about 1,600 km.",
  states: ['Gujarat']
},

{
  id: 'shortest_coastline',
  name: 'Shortest Coastline',
  question: 'Which state has the shortest coastline in India?',
  fact: "Goa has the shortest coastline among India's coastal states.",
  states: ['Goa']
},

{
  id: 'largest_forest_area',
  name: 'Largest Forest Area',
  question: 'Which state has the largest forest area in India?',
  fact: "Madhya Pradesh has the largest forest area in India.",
  states: ['Madhya Pradesh']
},

{
  id: 'highest_forest_cover_percentage',
  name: 'Highest Forest Cover Percentage',
  question: 'Which state has the highest percentage of forest cover?',
  fact: "Mizoram has the highest percentage of forest cover among Indian states.",
  states: ['Mizoram']
},

{
  id: 'highest_peak_state',
  name: 'Highest Peak',
  question: 'In which state is Kanchenjunga located?',
  fact: "Kanchenjunga, India's highest peak, is located in Sikkim.",
  states: ['Sikkim']
},

{
  id: 'largest_river_state',
  name: 'Longest River',
  question: 'The Ganga flows through the maximum length in which state?',
  fact: "Uttar Pradesh has the longest stretch of the Ganga River.",
  states: ['Uttar Pradesh']
},

{
  id: 'highest_coffee_production',
  name: 'Highest Coffee Producer',
  question: 'Which state is the largest coffee producer in India?',
  fact: "Karnataka is India's largest coffee-producing state.",
  states: ['Karnataka']
},

{
  id: 'highest_tea_production',
  name: 'Highest Tea Producer',
  question: 'Which state produces the most tea in India?',
  fact: "Assam is India's largest tea-producing state.",
  states: ['Assam']
},

{
  id: 'highest_rubber_production',
  name: 'Highest Rubber Producer',
  question: 'Which state is the largest producer of natural rubber?',
  fact: "Kerala is India's leading producer of natural rubber.",
  states: ['Kerala']
},

{
  id: 'highest_spice_production',
  name: 'Spice Capital',
  question: 'Which state is known as the Spice Garden of India?',
  fact: "Kerala is popularly known as the Spice Garden of India.",
  states: ['Kerala']
},

{
  id: 'highest_rice_production',
  name: 'Highest Rice Producer',
  question: 'Which state is the largest producer of rice in India?',
  fact: "West Bengal is India's largest rice-producing state.",
  states: ['West Bengal']
},

{
  id: 'highest_wheat_production',
  name: 'Highest Wheat Producer',
  question: 'Which state is the largest producer of wheat in India?',
  fact: "Uttar Pradesh is India's largest wheat-producing state.",
  states: ['Uttar Pradesh']
},

{
  id: 'highest_sugarcane_production',
  name: 'Highest Sugarcane Producer',
  question: 'Which state produces the most sugarcane in India?',
  fact: "Uttar Pradesh is India's largest sugarcane-producing state.",
  states: ['Uttar Pradesh']
},

{
  id: 'highest_cotton_production',
  name: 'Highest Cotton Producer',
  question: 'Which state is the largest producer of cotton?',
  fact: "Gujarat is India's leading cotton-producing state.",
  states: ['Gujarat']
},

{
  id: 'highest_milk_production',
  name: 'Highest Milk Producer',
  question: 'Which state is the largest producer of milk in India?',
  fact: "Uttar Pradesh is India's largest milk-producing state.",
  states: ['Uttar Pradesh']
},

{
  id: 'largest_national_park',
  name: 'Largest National Park',
  question: 'Which state has Hemis National Park, the largest national park in India?',
  fact: "Hemis National Park is located in Ladakh.",
  states: ['Ladakh']
},

{
  id: 'highest_tiger_population',
  name: 'Highest Tiger Population',
  question: 'Which state has the highest tiger population in India?',
  fact: "Madhya Pradesh has the highest tiger population according to the latest tiger census.",
  states: ['Madhya Pradesh']
},

{
  id: 'highest_elephant_population',
  name: 'Highest Elephant Population',
  question: 'Which state has the highest elephant population in India?',
  fact: "Karnataka has the highest elephant population in India.",
  states: ['Karnataka']
},

{
  ...
  fact: "The Thar Desert is primarily located in Rajasthan.",
  states: ['Rajasthan']
},

{
  id: 'highest_waterfall',
  name: 'Highest Waterfall',
  question: 'In which state is Kunchikal Falls located?',
  fact: "Kunchikal Falls, India's highest waterfall, is located in Karnataka.",
  states: ['Karnataka']
}
...
function mineralIconHtml(color, label){
  return `<div class="mineral-icon-wrap">
    <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
      <path d="M15 2 L26 10 L22 26 L8 26 L4 10 Z" fill="${color}" stroke="#1A2E3B" stroke-width="1" stroke-linejoin="round"/>
      <path d="M15 2 L15 26 M4 10 L26 10 M15 2 L8 26 M15 2 L22 26" stroke="#ffffff" stroke-width="0.9" opacity="0.45"/>
    </svg>
  </div>`;
}
function mineralDivIcon(color, label){
  return L.divIcon({
    className:'',
    html: mineralIconHtml(color, label),
    iconSize:[30,30],
    iconAnchor:[15,15]
  });
}
