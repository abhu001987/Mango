/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'island-navigator-india';
...
/* ============================================================
   INDIA (ANDAMAN) ISLANDS DATA
   Each site is a small polygon so the same distance/scoring math
   used for the Forest / Plateau / Coast Navigator (nearest-edge /
   inside-polygon) works unchanged. Islands are small and close
   together, so boxes are drawn tight to keep scoring meaningful.
   Add more entries any time (Nicobar islands, etc.) — shuffle,
...
/* Average the corner points of a round's boxes to get its display centre (for the island icon marker) */
...
const ROUNDS = [
  ...
  { id:'north_andaman', name:'North Andaman Island', region:'',
    fact:"The northernmost of the three main Andaman islands, home to Saddle Peak — the highest point in the Andaman and Nicobar Islands — and the town of Diglipur, known for its paddy fields and turtle-nesting beaches.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(13.30, 93.00, 0.14)
  },

  { id:'middle_andaman', name:'Middle Andaman Island', region:'',
    fact:"The central island of the Andaman group, connected to North Andaman by a strait crossed via the Austin Bridge, with Rangat and Mayabunder as its main towns and dense tropical forest cover inland.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(12.57, 92.90, 0.14)
  },

  { id:'south_andaman', name:'South Andaman Island', region:'',
    fact:"Home to Port Blair, the capital of the Andaman and Nicobar Islands, and the historic Cellular Jail. It is the most populated and developed island in the archipelago and the main gateway for travel to the islands.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(11.67, 92.72, 0.13)
  },

  { id:'baratang_island', name:'Baratang Island', region:'',
    fact:"An island between Middle and South Andaman known for its limestone caves, mud volcanoes and mangrove creeks, reached by a road-and-ferry route that is a popular day trip from Port Blair.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(12.13, 92.75, 0.10)
  },

  { id:'swaraj_dweep', name:'Swaraj Dweep (Havelock Island)', region:'',
    fact:"Renamed Swaraj Dweep in 2018, this island is the Andamans' best-known tourist destination, famous for Radhanagar Beach and popular diving and snorkelling sites in its surrounding waters.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(11.98, 93.00, 0.09)
  },

  { id:'shaheed_dweep', name:'Shaheed Dweep (Neil Island)', region:'',
    fact:"Renamed Shaheed Dweep in 2018, this small, laid-back island south of Havelock is known for its coral reefs, natural rock bridge formation and relaxed beach town atmosphere.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(11.83, 93.03, 0.07)
  },

  { id:'long_island', name:'Long Island', region:'',
    fact:"A quieter, less-visited island east of Middle Andaman, reachable by ferry, known for Lalaji Bay Beach and dense forest cover with relatively little tourist infrastructure.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(12.35, 92.87, 0.08)
  },

  { id:'interview_island', name:'Interview Island', region:'',
    fact:"An uninhabited wildlife sanctuary off the west coast of Middle Andaman, notable as a habitat for a population of feral elephants and for its restricted access aimed at conservation.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(12.90, 92.68, 0.10)
  },

  { id:'rutland_island', name:'Rutland Island', region:'',
    fact:"A largely forested island just south of South Andaman, separated from it by Duncan Passage, known for its beaches, coral reefs and limited permanent settlement.",
    states:['Andaman and Nicobar Islands'],
    paths: siteBox(11.55, 92.65, 0.09)
  },

  { id:'little_andaman', name:'Little Andaman Island', region:'',
  fact:"The southernmost major island of the Andaman group, known for Butler Bay Beach, White Surf Waterfall and the indigenous Onge tribe. It is separated from South Andaman by the Duncan Passage.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(10.70, 92.55, 0.12)
},

{ id:'barren_island', name:'Barren Island', region:'',
  fact:"India's only active volcano, located about 135 km northeast of Port Blair. The uninhabited volcanic island is part of the Andaman archipelago.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(12.28, 93.85, 0.05)
},

{ id:'narcondam', name:'Narcondam Island', region:'',
  fact:"A remote volcanic island in the Andaman Sea, famous as the only natural habitat of the endemic Narcondam Hornbill.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(13.43, 94.27, 0.05)
},

{ id:'car_nicobar', name:'Car Nicobar Island', region:'',
  fact:"The northernmost island of the Nicobar group and the administrative headquarters of Nicobar district, inhabited mainly by the Nicobarese tribe.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(9.17, 92.82, 0.09)
},

{ id:'chowra', name:'Chowra Island', region:'',
  fact:"A small Nicobar island known for its traditional pottery and seafaring community.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(8.47, 93.05, 0.05)
},

{ id:'teressa', name:'Teressa Island', region:'',
  fact:"One of the central Nicobar Islands, inhabited mainly by the Nicobarese people and covered with tropical forests.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(8.23, 93.03, 0.06)
},

{ id:'bompoka', name:'Bompoka Island', region:'',
  fact:"A small island in the central Nicobar group, located between Teressa and Kamorta islands.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(8.27, 93.08, 0.04)
},

{ id:'kamorta', name:'Kamorta Island', region:'',
  fact:"One of the largest Nicobar Islands, home to the administrative headquarters of the Nancowry group.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(8.05, 93.50, 0.07)
},

{ id:'nancowry', name:'Nancowry Island', region:'',
  fact:"A central Nicobar island separated from Kamorta by a narrow channel, forming the natural harbour of Nancowry.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(8.02, 93.53, 0.05)
},

{ id:'katchal', name:'Katchal Island', region:'',
  fact:"A forested Nicobar island situated south of the Nancowry group, inhabited by Nicobarese communities.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(7.93, 93.47, 0.07)
},

{ id:'little_nicobar', name:'Little Nicobar Island', region:'',
  fact:"Located south of Great Nicobar, this sparsely populated island is covered with dense tropical rainforest.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(7.12, 93.75, 0.08)
},

{ id:'great_nicobar', name:'Great Nicobar Island', region:'',
  fact:"The southernmost and largest island of India, home to Indira Point—the southernmost point of the country—and the Great Nicobar Biosphere Reserve.",
  states:['Andaman and Nicobar Islands'],
  paths: siteBox(7.00, 93.80, 0.14)
},

{ id:'kavaratti', name:'Kavaratti Island', region:'',
  fact:"The capital of Lakshadweep, known for its lagoons, coral reefs and administrative importance.",
  states:['Lakshadweep'],
  paths: siteBox(10.57, 72.64, 0.05)
},

{ id:'agatti', name:'Agatti Island', region:'',
  fact:"Home to Lakshadweep's only airport, serving as the main gateway to the archipelago.",
  states:['Lakshadweep'],
  paths: siteBox(10.85, 72.19, 0.05)
},

{ id:'bangaram', name:'Bangaram Island', region:'',
  fact:"An uninhabited coral atoll renowned for its white-sand beaches, turquoise lagoon and scuba diving.",
  states:['Lakshadweep'],
  paths: siteBox(10.94, 72.29, 0.04)
},

{ id:'kadmat', name:'Kadmat Island', region:'',
  fact:"A long, narrow coral island known for its extensive lagoon and water sports.",
  states:['Lakshadweep'],
  paths: siteBox(11.22, 72.78, 0.05)
},

{ id:'amini', name:'Amini Island', region:'',
  fact:"One of the oldest inhabited islands of Lakshadweep, known for traditional coir products and coral craftsmanship.",
  states:['Lakshadweep'],
  paths: siteBox(11.12, 72.73, 0.04)
},

{ id:'chetlat', name:'Chetlat Island', region:'',
  fact:"A small inhabited coral island in northern Lakshadweep known for fishing and coconut cultivation.",
  states:['Lakshadweep'],
  paths: siteBox(11.70, 72.71, 0.04)
},

{ id:'bitra', name:'Bitra Island', region:'',
  fact:"The smallest inhabited island of Lakshadweep, surrounded by rich coral reefs and bird habitats.",
  states:['Lakshadweep'],
  paths: siteBox(11.60, 72.20, 0.03)
},

{ id:'andrott', name:'Andrott Island', region:'',
  fact:"The largest island of Lakshadweep by area, known for the tomb of Saint Ubaidullah and its long human settlement history.",
  states:['Lakshadweep'],
  paths: siteBox(10.83, 73.68, 0.06)
},

{ id:'kalpeni', name:'Kalpeni Island', region:'',
  fact:"A group of three coral islands famous for its lagoon and extensive coral debris deposited by storms.",
  states:['Lakshadweep'],
  paths: siteBox(10.08, 73.64, 0.05)
},

{ id:'minicoy', name:'Minicoy Island', region:'',
  fact:"The southernmost island of Lakshadweep, culturally distinct from the northern islands and famous for its lighthouse and tuna fishing.",
  states:['Lakshadweep'],
  paths: siteBox(8.30, 73.05, 0.06)
},

{ id:'majuli', name:'Majuli', region:'',
  fact:"The world's largest inhabited river island, situated on the Brahmaputra River and renowned for its Vaishnavite monasteries (Satras).",
  states:['Assam'],
  paths: siteBox(26.95, 94.20, 0.11)
},

{ id:'umananda', name:'Umananda Island', region:'',
  fact:"A tiny river island in the Brahmaputra River at Guwahati, home to the historic Umananda Temple dedicated to Lord Shiva.",
  states:['Assam'],
  paths: siteBox(26.19, 91.75, 0.02)
},

{ id:'divar', name:'Divar Island', region:'',
  fact:"A river island on the Mandovi River in Goa, known for its Portuguese-era villages, churches and paddy fields.",
  states:['Goa'],
  paths: siteBox(15.50, 73.87, 0.04)
},

{ id:'st_marys', name:"St. Mary's Islands", region:'',
  fact:"A group of four small islands off the Karnataka coast, famous for their unique hexagonal basalt lava columns.",
  states:['Karnataka'],
  paths: siteBox(13.38, 74.67, 0.03)
},

{ id:'willingdon', name:'Willingdon Island', region:'',
  fact:"A man-made island in Kochi created during dredging of the harbour, serving as a major port and naval base.",
  states:['Kerala'],
  paths: siteBox(9.96, 76.26, 0.03)
},

{ id:'munroe', name:'Munroe Island', region:'',
  fact:"A cluster of islands at the confluence of Ashtamudi Lake and the Kallada River, known for its scenic backwaters.",
  states:['Kerala'],
  paths: siteBox(8.97, 76.61, 0.04)
},

{ id:'pamban', name:'Pamban Island', region:'',
  fact:"Also known as Rameswaram Island, it is connected to mainland India by the Pamban Bridge and is home to the famous Ramanathaswamy Temple.",
  states:['Tamil Nadu'],
  paths: siteBox(9.28, 79.30, 0.09)
}
...
/* ---------------- Map setup (Andaman & Nicobar in focus) ---------------- */
const map = L.map('map', {
  worldCopyJump:false,
  dragging:true,
  touchZoom:true,
...
const labelTiles = L.tileLayer('https://{s}.basemaps.cartocdn.com/light_only_labels/{z}/{x}/{y}{r}.png', {
  subdomains:'abcd', minZoom:4, maxZoom:19, keepBuffer:4, updateWhenZooming:false, crossOrigin:true
}).addTo(map);
...
/* ---------------- Indian states/UTs overlay (for round-result highlighting) ----------------
   Highlights just the STATE/UT an island lies in, not the whole country — more useful for
...
/* Alias table for the few state/UT names that differ between our round data and the
...
const STATE_NAME_ALIASES = {
  ...
  'andaman and nicobar islands': ['andaman and nicobar islands', 'andaman & nicobar islands', 'andaman and nicobar', 'andaman & nicobar']
};
...
/* ---------------- Island icon (shown over the reveal location, on top of the highlighted state) ---------------- */
function islandIconHtml(color, label){
  return `<div class="island-icon-wrap">
...
function islandDivIcon(color, label){
  return L.divIcon({
    className:'',
    html: islandIconHtml(color, label),   // ✅ matches the function you actually defined above it
    iconSize:[36,26],
    iconAnchor:[18,13]
  });
}
...
/* Is the guess anywhere inside the island's actual state/UT? */
...
function nearestOnPaths(p, paths){
  // Inside the island's marker box? Full credit — distance 0.
...
function lockGuess(){
  ...
  // If you're outside the island's marker box but inside the state/UT it actually
  ...
  // Fly the map to fit both the guess and the real island, so the
  ...
  map.flyToBounds(bounds, { padding:[80,80], maxZoom:11, duration:1.1, easeLinearity:0.25 });
...
function revealResult(round, gLatLng, nearest, km, v, pts){
  ...
  // Island icon marker, placed directly over the island's location on the map
  // so the player sees exactly where — and over which state/UT — it sits.
  const centerColor = VERDICT_HIGHLIGHT_COLOR[v.cls] || '#D4A853';
  const islandMarker = L.marker(centerOfPaths(round.paths), {
    icon: islandDivIcon(centerColor, round.name),
    interactive:false
  }).addTo(map);
  revealLayers.push(islandMarker);
...
async function endGame(){
  ...
  let msg;
  if(avg >= 85) msg = "Master of the Andaman archipelago. UPSC map-based questions won't stand a chance.";
  else if(avg >= 65) msg = "Sharp sense of the map — a seasoned reading of India's islands.";
  else if(avg >= 40) msg = "Solid run. These islands sit close together — chart again to sharpen your eye.";
  else msg = "";
  ...
  if(mode === 'challenge' && rival){
    ...
    if(avg > rival.score){
      ...
      vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> Your rival read the islands closer. Chart again!';
...
function showReplyComparison(data){
  ...
  if(currentAvgScore > rival.score){
    ...
    vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> They read the islands closer this time.';
    vb.classList.add('lose');
  } else {
...
async function ensureChallengeLinkReady(){
  ...
  try{
    ...
    const msg = `🏝️ I just charted the Island Navigator (India) and scored ${currentAvgScore}%. Think you can pin the islands closer? Take the same targets: ${link}`;
    document.getElementById('wa-share').href = 'https://wa.me/?text=' + encodeURIComponent(msg);
    document.getElementById('tg-share').href = 'https://t.me/share/url?url=' + encodeURIComponent(link) + '&text=' + encodeURIComponent(`🏝️ Think you can beat my Island Navigator score of ${currentAvgScore}%?`);
