/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'pass-navigator-world';
...
/* ============================================================
   WORLD MOUNTAIN PASSES & BORDER CROSSINGS DATA
   Each entry is placed at its real location. Unlike the India-only
   Navigator games, this map stays at world scale throughout — the
   camera never zooms in to a single country's outline. Distance
   scoring and full-credit zones are scaled up accordingly for
   continent-spanning geography (see scoreFor/verdictFor below).
   ============================================================ */
...
const ROUNDS = [
  ...
  { id:'khyber_pass', name:'Khyber Pass', region:'',
    fact:"Khyber Pass lies on the border between Pakistan and Afghanistan, cutting through the Safed Koh mountains. It has long served as a key historic route connecting Central Asia with South Asia and the Indian subcontinent.",
    countries:['Pakistan','Afghanistan'],
    paths: siteBox(34.0847, 71.0722)
  },

  { id:'bolan_pass', name:'Bolan Pass', region:'',
    fact:"Bolan Pass lies in Balochistan, Pakistan, and has historically linked Afghanistan with the plains of the Indus valley. It served as an important corridor for trade and military movement between Central and South Asia.",
    countries:['Pakistan'],
    paths: siteBox(29.8667, 67.4667)
  },

  { id:'salang_pass', name:'Salang Pass', region:'',
    fact:"Salang Pass crosses the Hindu Kush range in Afghanistan and is traversed by the Salang Tunnel. It forms a major route linking northern Afghanistan with Kabul and the rest of the country.",
    countries:['Afghanistan'],
    paths: siteBox(35.3167, 69.0167)
  },

  { id:'khunjerab_pass', name:'Khunjerab Pass', region:'',
    fact:"Khunjerab Pass lies on the border between Pakistan and China and carries the Karakoram Highway. It is one of the highest paved international border crossings in the world.",
    countries:['Pakistan','China'],
    paths: siteBox(36.85, 75.42)
  },

  { id:'wakhan_corridor', name:'Wakhan Corridor Passes', region:'',
    fact:"The Wakhan Corridor is a narrow strip of Afghanistan that extends toward China, separating Tajikistan from Pakistan. Its high mountain passes have historically provided a strategic land connection between Afghanistan and its neighbours.",
    countries:['Afghanistan'],
    paths: siteBox(37.05, 73.7)
  },

  { id:'karakoram_pass', name:'Karakoram Pass', region:'',
    fact:"Karakoram Pass lies in the high-altitude Ladakh–Aksai Chin region along the Karakoram range, on a historic route once used by Central Asian trade caravans. It sits in the border area between India and China.",
    countries:['India','China'],
    paths: siteBox(35.53, 77.82)
  },

  { id:'pamir_region', name:'Pamir Pass / region', region:'',
    fact:"The Pamir region of Central Asia, centred on present-day Tajikistan, has long been an important high-mountain crossroads. Routes through its passes have historically linked South and Central Asia with China.",
    countries:['Tajikistan'],
    paths: siteBox(37.9667, 73.15)
  },

  { id:'torugart_pass', name:'Torugart Pass', region:'',
    fact:"Torugart Pass lies on the border between Kyrgyzstan and China and is one of the main crossings linking Central Asia with China's Xinjiang region. It sits at high elevation in the Tian Shan mountains.",
    countries:['Kyrgyzstan','China'],
    paths: siteBox(40.5167, 75.4167)
  },

  { id:'irkeshtam_pass', name:'Irkeshtam Pass', region:'',
    fact:"Irkeshtam Pass lies on the border between Kyrgyzstan and China in the Pamir-Alay mountains. It is an important trade route connecting Central Asia with western China.",
    countries:['Kyrgyzstan','China'],
    paths: siteBox(39.7333, 74.0333)
  },

  { id:'brenner_pass', name:'Brenner Pass', region:'',
    fact:"Brenner Pass crosses the Alps on the border between Austria and Italy. It is one of the lowest and most heavily used Alpine passes, carrying a major road and rail route between the two countries.",
    countries:['Austria','Italy'],
    paths: siteBox(47.0022, 11.5064)
  },

  { id:'st_gotthard_pass', name:'St. Gotthard Pass', region:'',
    fact:"St. Gotthard Pass lies in the Swiss Alps and has long been one of the most important north-south crossings in Switzerland. It links the German-speaking north of the country with the Italian-speaking Ticino region in the south.",
    countries:['Switzerland'],
    paths: siteBox(46.5581, 8.5644)
  },

  { id:'stelvio_pass', name:'Stelvio Pass', region:'',
    fact:"Stelvio Pass lies in the Eastern Alps of northern Italy, close to the border with Switzerland. It is one of the highest paved mountain passes in the Alps, known for its many hairpin bends.",
    countries:['Italy'],
    paths: siteBox(46.5286, 10.4527)
  },

  { id:'simplon_pass', name:'Simplon Pass', region:'',
    fact:"Simplon Pass crosses the Alps between Switzerland and Italy and is complemented by the Simplon Tunnel below it. It has long been an important route linking the two countries across the Alps.",
    countries:['Switzerland','Italy'],
    paths: siteBox(46.2564, 8.0296)
  },

  { id:'cumberland_gap', name:'Cumberland Gap', region:'',
    fact:"Cumberland Gap is a pass through the Appalachian Mountains near the meeting point of Kentucky, Tennessee and Virginia in the United States. It was a key route used by early settlers moving westward into the American frontier.",
    countries:['United States of America'],
    paths: siteBox(36.6, -83.68)
  },

  { id:'chilkoot_pass', name:'Chilkoot Pass', region:'',
    fact:"Chilkoot Pass lies on the border between Alaska in the United States and British Columbia in Canada. It became famous as a route used by prospectors during the Klondike Gold Rush.",
    countries:['United States of America','Canada'],
    paths: siteBox(59.55, -135.35)
  },
  { id:'shipki_pass', name:'Shipka Pass', region:'',
  fact:"Shipka Pass crosses the Balkan Mountains in central Bulgaria. It has been a strategically important route between northern and southern Bulgaria and was the site of decisive battles during the Russo-Turkish War.",
  countries:['Bulgaria'],
  paths: siteBox(42.75, 25.32)
},

{ id:'thermopylae_pass', name:'Thermopylae Pass', region:'',
  fact:"Thermopylae is a narrow mountain pass in Greece famous for the Battle of Thermopylae in 480 BC, where a small Greek force resisted the invading Persian army.",
  countries:['Greece'],
  paths: siteBox(38.80, 22.54)
},

{ id:'bering_pass', name:'Bering Pass (Bering Strait Crossing)', region:'',
  fact:"Although not a mountain pass, the narrow Bering Strait has long been regarded as the natural gateway between Asia and North America and is believed to have been crossed via the Bering Land Bridge during prehistoric migrations.",
  countries:['Russia','United States of America'],
  paths: siteBox(65.95, -168.95)
},

{ id:'nathu_la', name:'Nathu La', region:'',
  fact:"Nathu La is a high mountain pass in the eastern Himalayas connecting India's Sikkim state with Tibet in China. It was an important branch of the ancient Silk Road and is now an official border trade crossing.",
  countries:['India','China'],
  paths: siteBox(27.39, 88.83)
},

{ id:'jelep_la', name:'Jelep La', region:'',
  fact:"Jelep La is a Himalayan pass between India and Tibet that historically carried trade between Bengal and the Chumbi Valley before Nathu La became the principal crossing.",
  countries:['India','China'],
  paths: siteBox(27.34, 88.76)
},

{ id:'zoji_la', name:'Zoji La', region:'',
  fact:"Zoji La is a major Himalayan pass linking the Kashmir Valley with Ladakh. It is a vital all-weather strategic route in northern India.",
  countries:['India'],
  paths: siteBox(34.28, 75.55)
},

{ id:'rohtang_pass', name:'Rohtang Pass', region:'',
  fact:"Rohtang Pass crosses the eastern Pir Panjal range in the Himalayas, connecting the Kullu Valley with Lahaul in northern India.",
  countries:['India'],
  paths: siteBox(32.37, 77.25)
},

{ id:'natron_pass', name:'Nares Strait Pass', region:'',
  fact:"Nares Strait forms an important Arctic passage between Greenland and Canada's Ellesmere Island, linking Baffin Bay with the Arctic Ocean.",
  countries:['Canada','Greenland'],
  paths: siteBox(80.00, -68.00)
},

{ id:'torkham', name:'Torkham Pass', region:'',
  fact:"Torkham is the principal border crossing through the Khyber Pass between Pakistan and Afghanistan and one of South Asia's busiest international land crossings.",
  countries:['Pakistan','Afghanistan'],
  paths: siteBox(34.11, 71.09)
},

{ id:'san_bernardino_pass', name:'San Bernardino Pass', region:'',
  fact:"San Bernardino Pass crosses the Swiss Alps and has been an important north-south trade route between Switzerland and Italy since Roman times.",
  countries:['Switzerland'],
  paths: siteBox(46.50, 9.17)
}
...
/* ---------------- Map setup (world view — never zoomed to a single country) ---------------- */
const map = L.map('map', {
  worldCopyJump:false,
  dragging:true,
  touchZoom:true,
...
const WORLD_HOME_VIEW = { center:[30, 45], zoom:2.4 };
...
/* ---------------- World countries overlay (for round-result highlighting) ----------------
   Highlights just the COUNTRY (or countries) a pass/crossing lies in — mirrors the state
   highlighting used by the India-only Navigator games, but against a world boundary set. */
...
/* Alias table for the few country names that differ between our round data and the
   source dataset's name property. */
...
/* Colors mirror the same good/mid/bad verdict palette used for round feedback,
   so the highlighted country visually echoes how close the guess was. */
...
/* ---------------- Target icon (shown over the reveal location, on top of the highlighted country) ---------------- */
function mineralIconHtml(color, label){
  return `<div class="mineral-icon-wrap">
    <svg width="30" height="30" viewBox="0 0 30 30" xmlns="http://www.w3.org/2000/svg">
      <path d="M3 24 L11 10 L15 17 L19 8 L27 24 Z" fill="${color}" stroke="#1A2E3B" stroke-width="1" stroke-linejoin="round"/>
      <path d="M11 10 L15 17 L19 8" stroke="#ffffff" stroke-width="0.9" opacity="0.45" fill="none"/>
    </svg>
...
/* Is the guess anywhere inside the pass/crossing's actual host country/countries? */
...
function lockGuess(){
  ...
  // If you're outside the target's marker box but inside a country that actually
  ...
  const scoringKm = insideCountry ? Math.min(km, 600) : km;
  ...
  // Fly the map to fit both the guess and the real pass/crossing, so the
...
function revealResult(round, gLatLng, nearest, km, v, pts){
  ...
  // Target icon marker, placed directly over the pass/crossing's location on the
  // map so the player sees exactly where — and over which country/countries — it lies.
...
async function endGame(){
  ...
  let msg;
  if(avg >= 85) msg = "Master of world mountain-pass geography. Exam-style map questions won't stand a chance.";
  else if(avg >= 65) msg = "Sharp sense of the map — a seasoned reading of the world's key passes and crossings.";
  else if(avg >= 40) msg = "Solid run. These crossings span a lot of ground — chart again to sharpen your eye.";
  else msg = "";
  ...
  if(mode === 'challenge' && rival){
    ...
    if(avg > rival.score){
      ...
      vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> Your rival read the world map closer. Chart again!';
...
function showReplyComparison(data){
  ...
  if(currentAvgScore > rival.score){
    ...
    vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> They read the world map closer this time.';
    vb.classList.add('lose');
  } else {
...
async function ensureChallengeLinkReady(){
  ...
  try{
    ...
    const msg = `⛰️ I just charted the World Pass Navigator and scored ${currentAvgScore}%. Think you can pin the world's mountain passes closer? Take the same targets: ${link}`;
    document.getElementById('wa-share').href = 'https://wa.me/?text=' + encodeURIComponent(msg);
    document.getElementById('tg-share').href = 'https://t.me/share/url?url=' + encodeURIComponent(link) + '&text=' + encodeURIComponent(`⛰️ Think you can beat my World Pass Navigator score of ${currentAvgScore}%?`);
