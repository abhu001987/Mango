/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'pass-tunnel-navigator-india';
...
/* ============================================================
   INDIA MOUNTAIN PASSES & TUNNELS DATA
   Each entry is placed at its real location so distinct passes or
   tunnels from the same state — e.g. Rohtang Pass, Atal Tunnel and
   Baralacha La are all in Himachal Pradesh — still land at different
   points on the map. Each site is a small polygon so the same
   distance/scoring math used for the Dam / Mineral Navigator (nearest-
   edge / inside-polygon) works unchanged. Add more entries any time —
   shuffle, scoring and challenge links all keep working automatically.
   ============================================================ */
...
const ROUNDS = [
  ...
  { id:'rohtang_pass', name:'Rohtang Pass', region:'',
    fact:"Rohtang Pass lies on the Kullu–Lahaul & Spiti route in Himachal Pradesh. It is a traditional crossing of the Pir Panjal range and was, for decades, the main gateway from the Kullu valley into Lahaul and Spiti.",
    states:['Himachal Pradesh'],
    paths: siteBox(32.3728, 77.2497, 0.10)
  },

  { id:'atal_tunnel', name:'Atal Tunnel', region:'',
    fact:"The Atal Tunnel runs under the Rohtang Pass in Himachal Pradesh. It connects Manali with Lahaul and provides all-weather connectivity to a region that was earlier cut off for months by snow.",
    states:['Himachal Pradesh'],
    paths: siteBox(32.4302, 77.2419, 0.09)
  },

  { id:'baralacha_la', name:'Baralacha La', region:'',
    fact:"Baralacha La lies on the Manali–Leh highway in Himachal Pradesh. The pass connects the Lahaul valley with Ladakh and marks an important watershed point on the route.",
    states:['Himachal Pradesh'],
    paths: siteBox(32.7333, 77.4167, 0.10)
  },

  { id:'kunzum_pass', name:'Kunzum Pass', region:'',
    fact:"Kunzum Pass connects the Lahaul and Spiti valleys in Himachal Pradesh. It sits at the head of the Chandra valley and is an important link within the Lahaul & Spiti district.",
    states:['Himachal Pradesh'],
    paths: siteBox(32.4167, 77.6167, 0.10)
  },

  { id:'shipki_la', name:'Shipki La', region:'',
    fact:"Shipki La lies on the India–Tibet (China) border in Himachal Pradesh. The Sutlej River enters India near this pass, making it an important point in the state's trans-Himalayan geography.",
    states:['Himachal Pradesh'],
    paths: siteBox(31.85, 78.75, 0.10)
  },

  { id:'jalori_pass', name:'Jalori Pass', region:'',
    fact:"Jalori Pass lies in the Kullu district of Himachal Pradesh. It connects the Kullu valley with the Banjar and Tirthan valleys and is a lower, more accessible Himalayan crossing than the high trans-Himalayan passes.",
    states:['Himachal Pradesh'],
    paths: siteBox(31.6167, 77.3667, 0.09)
  },

  { id:'zoji_la', name:'Zoji La', region:'',
    fact:"Zoji La connects the Kashmir Valley with Ladakh on the Srinagar–Leh highway. It is one of India's most strategically important passes, and a tunnel is being built beneath it for all-weather access.",
    states:['Jammu & Kashmir'],
    paths: siteBox(34.28, 75.48, 0.10)
  },

  { id:'banihal_pass', name:'Banihal Pass', region:'',
    fact:"Banihal Pass crosses the Pir Panjal range between Jammu and the Kashmir Valley. The historic Jawahar Tunnel and the newer Chenani–Nashri Tunnel both provide passage through this range along NH44.",
    states:['Jammu & Kashmir'],
    paths: siteBox(33.45, 75.20, 0.10)
  },

  { id:'chenani_nashri_tunnel', name:'Chenani-Nashri Tunnel', region:'',
    fact:"The Chenani-Nashri Tunnel, also called the Patnitop Tunnel, runs under the Patnitop hills on NH44 in Jammu and Kashmir. It shortens the Jammu–Srinagar route and bypasses a landslide-prone stretch.",
    states:['Jammu & Kashmir'],
    paths: siteBox(33.03, 75.27, 0.09)
  },

  { id:'pir_panjal_pass', name:'Pir Panjal Pass', region:'',
    fact:"The Pir Panjal Pass lies on the historic Mughal Road linking Jammu's Poonch region with the Kashmir Valley. It gives its name to the wider Pir Panjal range of the Lesser Himalayas.",
    states:['Jammu & Kashmir'],
    paths: siteBox(33.3, 74.53, 0.10)
  },

  { id:'sinthan_top', name:'Sinthan Top', region:'',
    fact:"Sinthan Top connects the Anantnag district of the Kashmir Valley with the Kishtwar region of Jammu. It is an important alternative route between the two regions of Jammu and Kashmir.",
    states:['Jammu & Kashmir'],
    paths: siteBox(33.6, 75.3, 0.10)
  },

  { id:'chang_la', name:'Chang La', region:'',
    fact:"Chang La lies on the route connecting Leh with the Pangong Tso lake in Ladakh. It is one of the high passes that gives access to the Changthang plateau.",
    states:['Ladakh'],
    paths: siteBox(34.0167, 77.6167, 0.10)
  },

  { id:'khardung_la', name:'Khardung La', region:'',
    fact:"Khardung La lies north of Leh in Ladakh and connects the Leh valley with the Nubra valley. It has long been promoted as one of the world's highest motorable passes.",
    states:['Ladakh'],
    paths: siteBox(34.2833, 77.6, 0.10)
  },

  { id:'pensi_la', name:'Pensi La', region:'',
    fact:"Pensi La connects the Kargil district with the Zanskar valley in Ladakh. It lies close to the Drang-Drung Glacier, an important source of the Stod River.",
    states:['Ladakh'],
    paths: siteBox(34.0, 76.35, 0.10)
  },

  { id:'umling_la', name:'Umling La', region:'',
    fact:"Umling La lies on the road connecting Chisumle and Demchok in eastern Ladakh, near the border with Tibet. The route across it has been promoted as one of the highest motorable roads in the world.",
    states:['Ladakh'],
    paths: siteBox(32.98, 78.75, 0.10)
  },

  { id:'nathu_la', name:'Nathu La', region:'',
    fact:"Nathu La lies on the India–China border in Sikkim, on the old trade route between India and Tibet. It has been reopened for limited border trade and pilgrimage in recent decades.",
    states:['Sikkim'],
    paths: siteBox(27.3866, 88.8410, 0.09)
  },

  { id:'jelep_la', name:'Jelep La', region:'',
    fact:"Jelep La lies close to Nathu La on the Sikkim–Tibet border. It was historically an important pass on the trade route between Lhasa and the Indian plains via Kalimpong.",
    states:['Sikkim'],
    paths: siteBox(27.2833, 88.85, 0.09)
  },

  { id:'se_la_pass', name:'Se La Pass', region:'',
    fact:"Se La Pass connects Tezpur in Assam with Tawang in Arunachal Pradesh. It lies on a strategically important route toward the India–China border in the eastern Himalayas.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.5167, 92.4, 0.10)
  },

  { id:'sela_tunnel', name:'Sela Tunnel', region:'',
    fact:"The Sela Tunnel runs beneath the Se La Pass in Arunachal Pradesh, providing all-weather connectivity to Tawang. It was built to bypass the pass's heavy winter snowfall.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.505, 92.39, 0.09)
  },

  { id:'bum_la_pass', name:'Bum La Pass', region:'',
    fact:"Bum La Pass lies on the India–China border near Tawang in Arunachal Pradesh. It sits close to the historic route once used for trade and travel between Tibet and the Tawang region.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.75, 91.9, 0.10)
  },

  { id:'bomdila_pass', name:'Bomdila Pass', region:'',
    fact:"Bomdila Pass lies on the route between Tezpur and Tawang in Arunachal Pradesh, close to the town of Bomdila. It is an important stop on the way toward the higher Se La Pass.",
    states:['Arunachal Pradesh'],
    paths: siteBox(27.2646, 92.4159, 0.09)
  },

  { id:'lipulekh_pass', name:'Lipulekh Pass', region:'',
    fact:"Lipulekh Pass lies in Uttarakhand near the tri-junction of India, Nepal and Tibet (China). It has traditionally been used for trade with Tibet and for the Kailash Mansarovar pilgrimage route.",
    states:['Uttarakhand'],
    paths: siteBox(30.2, 81.0, 0.10)
  },

  { id:'niti_pass', name:'Niti Pass', region:'',
    fact:"Niti Pass lies in the Chamoli district of Uttarakhand, close to the India–China border. It lies near the Niti valley, historically used as a trade route into Tibet.",
    states:['Uttarakhand'],
    paths: siteBox(30.9667, 79.9167, 0.10)
  },

  { id:'mana_pass', name:'Mana Pass', region:'',
    fact:"Mana Pass lies near Mana village in Uttarakhand, close to the India–China border and not far from Badrinath. It lies near the source region of the Saraswati and Alaknanda rivers.",
    states:['Uttarakhand'],
    paths: siteBox(30.87, 79.62, 0.10)
  },

  { id:'fotu_la', name:'Fotu La', region:'',
  fact:"The highest pass on the Srinagar–Leh National Highway (NH-1), connecting Kargil and Leh through the Ladakh Range.",
  states:['Ladakh'],
  paths: siteBox(34.28, 76.53, 0.09)
},

{ id:'namika_la', name:'Namika La', region:'',
  fact:"A high mountain pass on the Srinagar–Leh highway between Kargil and Leh, located west of Fotu La.",
  states:['Ladakh'],
  paths: siteBox(34.37, 76.49, 0.09)
},

{ id:'lachulung_la', name:'Lachulung La', region:'',
  fact:"A high pass on the Leh–Manali highway between Pang and Sarchu in Ladakh.",
  states:['Ladakh'],
  paths: siteBox(33.50, 77.62, 0.10)
},

{ id:'nakee_la', name:'Nakee La', region:'',
  fact:"A mountain pass on the Leh–Manali highway, situated between Sarchu and Pang.",
  states:['Ladakh'],
  paths: siteBox(33.65, 77.55, 0.09)
},

{ id:'tanglang_la', name:'Tanglang La', region:'',
  fact:"One of the highest mountain passes on the Leh–Manali highway, connecting the Indus Valley with the More Plains.",
  states:['Ladakh'],
  paths: siteBox(33.50, 77.78, 0.10)
},

{ id:'rezang_la', name:'Rezang La', region:'',
  fact:"A strategically important pass near Chushul in eastern Ladakh, famous for the Battle of Rezang La during the 1962 India–China War.",
  states:['Ladakh'],
  paths: siteBox(33.42, 78.82, 0.09)
},

{ id:'debsa_pass', name:'Debsa Pass', region:'',
  fact:"A high mountain pass connecting the Spiti Valley of Himachal Pradesh with Ladakh via a traditional trekking route.",
  states:['Himachal Pradesh','Ladakh'],
  paths: siteBox(32.93, 77.80, 0.09)
},

{ id:'parang_la', name:'Parang La', region:'',
  fact:"A historic pass connecting Spiti Valley in Himachal Pradesh with the Changthang region of Ladakh.",
  states:['Himachal Pradesh','Ladakh'],
  paths: siteBox(32.58, 78.05, 0.09)
},

{ id:'dongkha_la', name:'Dongkha La', region:'',
  fact:"A high pass near Gurudongmar Lake in North Sikkim, close to the India–China border.",
  states:['Sikkim'],
  paths: siteBox(28.03, 88.72, 0.09)
},

{ id:'diphu_pass', name:'Diphu Pass', region:'',
  fact:"A tri-junction pass near the borders of India, China and Myanmar in eastern Arunachal Pradesh.",
  states:['Arunachal Pradesh'],
  paths: siteBox(28.23, 97.03, 0.09)
},

{ id:'bomdi_la', name:'Bomdi La', region:'',
  fact:"A mountain pass near Bomdila in Arunachal Pradesh on the route to Tawang.",
  states:['Arunachal Pradesh'],
  paths: siteBox(27.26, 92.42, 0.09)
}
...
/* ---------------- Indian states overlay (for round-result highlighting) ----------------
   Highlights just the STATE a pass or tunnel lies in, not the whole country — more useful
...
/* Alias table for the few state/UT names that differ between our round data and the
   source dataset's name property (e.g. Delhi is sometimes "NCT of Delhi", Ladakh may
   appear merged with Jammu & Kashmir in older datasets). */
const STATE_NAME_ALIASES = {
  'delhi': ['delhi', 'nct of delhi', 'national capital territory of delhi'],
  'odisha': ['odisha', 'orissa'],
  'uttarakhand': ['uttarakhand', 'uttaranchal'],
  'ladakh': ['ladakh', 'jammu and kashmir', 'jammu & kashmir']
};
...
/* ---------------- Target icon (shown over the reveal location, on top of the highlighted state) ---------------- */
...
/* Is the guess anywhere inside the pass/tunnel's actual host state? */
...
function lockGuess(){
  ...
  // If you're outside the target's marker box but inside the state that actually
  // hosts it, don't torch the score for it — cap the *scoring* distance.
  ...
  // Fly the map to fit both the guess and the real pass/tunnel, so the
...
function revealResult(round, gLatLng, nearest, km, v, pts){
  ...
  // Target icon marker, placed directly over the pass/tunnel's location on the
  // map so the player sees exactly where — and over which state — it lies.
  const centerColor = VERDICT_HIGHLIGHT_COLOR[v.cls] || '#D4A853';
  const targetMarker = L.marker(centerOfPaths(round.paths), {
...
async function endGame(){
  ...
  let msg;
  if(avg >= 85) msg = "Master of Indian mountain geography. UPSC map-based questions won't stand a chance.";
  else if(avg >= 65) msg = "Sharp sense of the map — a seasoned reading of India's passes and tunnels.";
  else if(avg >= 40) msg = "Solid run. These mountain routes are tricky — chart again to sharpen your eye.";
  else msg = "";
  ...
  if(mode === 'challenge' && rival){
    ...
    if(avg > rival.score){
      ...
      vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> Your rival read the mountain routes closer. Chart again!';
...
function showReplyComparison(data){
  ...
  if(currentAvgScore > rival.score){
    ...
    vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> They read the mountain routes closer this time.';
    vb.classList.add('lose');
  } else {
...
async function ensureChallengeLinkReady(){
  ...
  try{
    ...
    const msg = `⛰️ I just charted the Pass & Tunnel Navigator (India) and scored ${currentAvgScore}%. Think you can pin the mountain routes closer? Take the same targets: ${link}`;
    document.getElementById('wa-share').href = 'https://wa.me/?text=' + encodeURIComponent(msg);
    document.getElementById('tg-share').href = 'https://t.me/share/url?url=' + encodeURIComponent(link) + '&text=' + encodeURIComponent(`⛰️ Think you can beat my Pass & Tunnel Navigator score of ${currentAvgScore}%?`);
