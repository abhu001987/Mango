/* ============================================================
   GAME / API CONFIG
   ============================================================ */
const GAME_TYPE = 'sea-navigator-world';
...
/* ============================================================
   WORLD SEAS DATA
   Each entry is placed at (and boxed around) its real location,
   sized roughly to the sea's actual extent. There's no country
   or flow direction to show here — the reveal draws the sea's
   own area as an animated, gently pulsing water outline instead.
   The map stays at world scale throughout — it never zooms to a
   single country.
   ============================================================ */
...
const ROUNDS = [
  ...
  { id:'mediterranean_sea', name:'Mediterranean Sea', region:'',
    fact:"The Mediterranean Sea lies between Europe, North Africa and the Levant, connected to the Atlantic Ocean through the narrow Strait of Gibraltar and to the Black Sea through the Bosporus and Dardanelles.",
    paths: siteBox(35.0, 18.0, 6.0)
  },

  { id:'black_sea', name:'Black Sea', region:'',
    fact:"The Black Sea sits between southeastern Europe and Asia Minor, bordered by Turkey, Bulgaria, Romania, Ukraine, Russia and Georgia, and connects to the Mediterranean through the Bosporus Strait.",
    paths: siteBox(43.5, 34.5, 3.0)
  },

  { id:'caspian_sea', name:'Caspian Sea', region:'',
    fact:"The Caspian Sea is the world's largest inland body of water, a landlocked sea bordered by Russia, Kazakhstan, Turkmenistan, Iran and Azerbaijan.",
    paths: siteBox(41.5, 51.0, 3.5)
  },

  { id:'red_sea', name:'Red Sea', region:'',
    fact:"The Red Sea is a narrow sea between northeast Africa and the Arabian Peninsula, linked to the Mediterranean via the Suez Canal and to the Indian Ocean through the Bab-el-Mandeb strait and Gulf of Aden.",
    paths: siteBox(20.0, 38.0, 3.5)
  },

  { id:'arabian_sea', name:'Arabian Sea', region:'',
    fact:"The Arabian Sea is a section of the northern Indian Ocean bounded by the Arabian Peninsula to the west and the Indian subcontinent to the east.",
    paths: siteBox(15.0, 65.0, 6.0)
  },

  { id:'caribbean_sea', name:'Caribbean Sea', region:'',
    fact:"The Caribbean Sea is part of the Atlantic Ocean, bordered by Central America, northern South America and the arc of Caribbean islands known as the Antilles.",
    paths: siteBox(15.0, -75.0, 5.0)
  },

  { id:'baltic_sea', name:'Baltic Sea', region:'',
    fact:"The Baltic Sea is a largely enclosed sea in northern Europe, bordered by Scandinavia, the Baltic states, Germany, Poland and Russia, and connects to the North Sea through the Danish straits.",
    paths: siteBox(58.5, 19.5, 3.0)
  },

  { id:'north_sea', name:'North Sea', region:'',
    fact:"The North Sea lies between Great Britain and continental Europe, bordered by the Netherlands, Germany, Denmark and Norway, and forms part of the Atlantic Ocean.",
    paths: siteBox(56.0, 3.5, 3.0)
  },

  { id:'yellow_sea', name:'Yellow Sea', region:'',
    fact:"The Yellow Sea is a part of the Pacific Ocean lying between mainland China and the Korean Peninsula, named for the pale silt carried into it by rivers such as the Yellow River.",
    paths: siteBox(35.0, 123.0, 2.5)
  },

  { id:'south_china_sea', name:'South China Sea', region:'',
    fact:"The South China Sea is a marginal sea of the Pacific Ocean bordered by China, Vietnam, the Philippines, Malaysia, Brunei and Indonesia, and is one of the world's busiest shipping regions.",
    paths: siteBox(12.0, 114.0, 6.0)
  },

  { id:'sea_of_japan', name:'Sea of Japan (East Sea)', region:'',
    fact:"The Sea of Japan, also known as the East Sea, lies between the Japanese archipelago and the Korean Peninsula and Russian mainland.",
    paths: siteBox(40.0, 135.0, 3.0)
  },

  { id:'tasman_sea', name:'Tasman Sea', region:'',
    fact:"The Tasman Sea separates Australia from New Zealand, forming part of the South Pacific Ocean between the two countries.",
    paths: siteBox(-40.0, 160.0, 5.0)
  },

  { id:'andaman_sea', name:'Andaman Sea', region:'',
    fact:"The Andaman Sea is part of the Indian Ocean lying between the Andaman Islands and the coasts of Myanmar, Thailand and northern Sumatra.",
    paths: siteBox(10.0, 96.0, 2.5)
  },
  { id:'adriatic_sea', name:'Adriatic Sea', region:'',
  fact:"The Adriatic Sea is a northern arm of the Mediterranean Sea lying between the Italian Peninsula and the Balkan Peninsula, bordered by Italy, Slovenia, Croatia, Bosnia and Herzegovina, Montenegro and Albania.",
  paths: siteBox(43.5, 16.5, 2.5)
},

{ id:'aegean_sea', name:'Aegean Sea', region:'',
  fact:"The Aegean Sea is part of the eastern Mediterranean lying between Greece and Turkey, containing thousands of islands including the Cyclades and Dodecanese.",
  paths: siteBox(38.5, 25.0, 2.5)
},

{ id:'ionian_sea', name:'Ionian Sea', region:'',
  fact:"The Ionian Sea is part of the Mediterranean Sea lying south of the Adriatic, bordered by southern Italy, Albania and western Greece.",
  paths: siteBox(37.5, 19.5, 3.0)
},

{ id:'tyrrhenian_sea', name:'Tyrrhenian Sea', region:'',
  fact:"The Tyrrhenian Sea is part of the western Mediterranean lying between mainland Italy and the islands of Corsica, Sardinia and Sicily.",
  paths: siteBox(40.0, 12.0, 3.0)
},

{ id:'sea_of_marmara', name:'Sea of Marmara', region:'',
  fact:"The Sea of Marmara is an inland sea in northwestern Turkey connecting the Black Sea to the Aegean Sea through the Bosporus and Dardanelles straits.",
  paths: siteBox(40.8, 28.5, 1.5)
},

{ id:'norwegian_sea', name:'Norwegian Sea', region:'',
  fact:"The Norwegian Sea is a marginal sea of the North Atlantic Ocean lying between Norway, Iceland and the island of Jan Mayen.",
  paths: siteBox(67.0, 3.0, 5.0)
},

{ id:'barents_sea', name:'Barents Sea', region:'',
  fact:"The Barents Sea is an Arctic Ocean sea north of Norway and Russia, remaining largely ice-free year-round due to the warm North Atlantic Current.",
  paths: siteBox(74.0, 40.0, 5.0)
},

{ id:'bering_sea', name:'Bering Sea', region:'',
  fact:"The Bering Sea is a northern Pacific sea lying between Alaska and Russia, connected to the Arctic Ocean by the Bering Strait.",
  paths: siteBox(58.0, -178.0, 6.0)
},

{ id:'sea_of_okhotsk', name:'Sea of Okhotsk', region:'',
  fact:"The Sea of Okhotsk is a marginal sea of the northwest Pacific Ocean bordered by Russia's Kamchatka Peninsula, the Kuril Islands, Sakhalin Island and Hokkaido, Japan.",
  paths: siteBox(53.0, 150.0, 5.0)
},

{ id:'east_china_sea', name:'East China Sea', region:'',
  fact:"The East China Sea is a marginal sea of the western Pacific Ocean lying between eastern China, Taiwan, Japan's Ryukyu Islands and South Korea.",
  paths: siteBox(29.5, 126.5, 4.0)
},

{ id:'philippine_sea', name:'Philippine Sea', region:'',
  fact:"The Philippine Sea is the largest sea in the world, lying east of the Philippines and south of Japan in the western Pacific Ocean.",
  paths: siteBox(20.0, 135.0, 8.0)
},

{ id:'coral_sea', name:'Coral Sea', region:'',
  fact:"The Coral Sea lies off northeastern Australia and is home to the Great Barrier Reef, extending toward Papua New Guinea and the Solomon Islands.",
  paths: siteBox(-18.0, 154.0, 7.0)
},

{ id:'java_sea', name:'Java Sea', region:'',
  fact:"The Java Sea is a shallow sea of the western Pacific lying between the Indonesian islands of Java, Borneo, Sumatra and Sulawesi.",
  paths: siteBox(-5.5, 112.0, 4.0)
},

{ id:'timor_sea', name:'Timor Sea', region:'',
  fact:"The Timor Sea lies between northern Australia and the island of Timor, forming part of the eastern Indian Ocean.",
  paths: siteBox(-11.0, 127.0, 4.0)
},

{ id:'arafura_sea', name:'Arafura Sea', region:'',
  fact:"The Arafura Sea lies between northern Australia and southern New Guinea, connecting the Coral Sea with the Timor Sea.",
  paths: siteBox(-10.0, 136.0, 5.0)
},

{ id:'sulu_sea', name:'Sulu Sea', region:'',
  fact:"The Sulu Sea lies in the southwestern Philippines, bordered by the islands of Palawan, Mindoro, Panay and the Sulu Archipelago.",
  paths: siteBox(9.5, 120.5, 2.5)
},

{ id:'celebes_sea', name:'Celebes Sea', region:'',
  fact:"The Celebes Sea, also known as the Sulawesi Sea, lies between the southern Philippines and the Indonesian island of Sulawesi.",
  paths: siteBox(4.5, 123.5, 3.0)
},

{ id:'bismarck_sea', name:'Bismarck Sea', region:'',
  fact:"The Bismarck Sea lies northeast of Papua New Guinea, bounded by New Britain Island and the Admiralty Islands in the southwestern Pacific.",
  paths: siteBox(-3.0, 148.5, 3.5)
},

{ id:'solomon_sea', name:'Solomon Sea', region:'',
  fact:"The Solomon Sea lies between Papua New Guinea and the Solomon Islands, forming part of the southwestern Pacific Ocean.",
  paths: siteBox(-9.5, 153.0, 4.0)
},

{ id:'labrador_sea', name:'Labrador Sea', region:'',
  fact:"The Labrador Sea is a northern Atlantic sea lying between Greenland and the Labrador Peninsula of Canada.",
  paths: siteBox(59.0, -55.0, 5.0)
},

{ id:'greenland_sea', name:'Greenland Sea', region:'',
  fact:"The Greenland Sea is an Arctic Ocean sea lying east of Greenland and west of Svalbard and Iceland.",
  paths: siteBox(75.0, -5.0, 6.0)
},

{ id:'sargasso_sea', name:'Sargasso Sea', region:'',
  fact:"The Sargasso Sea is a unique region of the North Atlantic Ocean defined by ocean currents rather than land, famous for its floating mats of Sargassum seaweed.",
  paths: siteBox(30.0, -55.0, 7.0)
},

{ id:'weddell_sea', name:'Weddell Sea', region:'',
  fact:"The Weddell Sea is a large embayment of the Southern Ocean lying east of the Antarctic Peninsula, noted for its extensive sea ice.",
  paths: siteBox(-73.0, -40.0, 7.0)
},

{ id:'ross_sea', name:'Ross Sea', region:'',
  fact:"The Ross Sea is a deep bay of the Southern Ocean south of New Zealand, renowned for its rich marine ecosystems and the Ross Ice Shelf.",
  paths: siteBox(-75.0, 175.0, 8.0)
}
...
/* ---------------- Map setup (world scale — never zoomed to a single country) ---------------- */
const map = L.map('map', {
  worldCopyJump:false,
  dragging:true,
  touchZoom:true,
...
const WORLD_HOME_VIEW = { center:[25, 60], zoom:2.3 };
...
function waveIconHtml(color, label){
  return `<div class="mineral-icon-wrap">
    ...
    <span class="m-tag" style="--micon-color:${color}">${label}</span>
  </div>`;
}
...
/* Verdict → color used for the water reveal (same palette as the rest of the UI) */
...
function lockGuess(){
  ...
  // Fly the map to fit both the guess and the real sea, so the
...
/* ---------------- Water reveal (replaces country highlighting) ----------------
   Draws the sea's marker box as a gently pulsing, filled water outline —
   an animated dashed border plus a soft fill wash — so the player sees the
   sea's real extent without any political boundary being drawn around it. */
function drawFlowEffect(round, cls){
  ...
  round.paths.forEach((path, i)=>{
    const fill = L.polygon(path, { color: color, weight:0, fillColor: color, fillOpacity:0.14, className:'flow-fill', interactive:false }).addTo(map);
    revealLayers.push(fill);
  ...
  // Target icon marker, placed directly over the sea's location.
...
async function endGame(){
  ...
  let msg;
  if(avg >= 85) msg = "Master of world seas geography. Exam-style map questions won't stand a chance.";
  else if(avg >= 65) msg = "Sharp sense of the map — a seasoned reading of the world's key seas and the coasts they border.";
  else if(avg >= 40) msg = "Solid run. These seas span a lot of coastline — chart again to sharpen your eye.";
  else msg = "";
  ...
  if(mode === 'challenge' && rival){
    ...
    if(avg > rival.score){
      ...
      vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> Your rival read the map closer. Chart again!';
...
function showReplyComparison(data){
  ...
  if(currentAvgScore > rival.score){
    ...
    vb.innerHTML = '<svg viewBox="0 0 24 24"><path d="M16 8l-5 3-1 5 5-3z"/><circle cx="12" cy="12" r="9"/></svg> They read the map closer this time.';
    vb.classList.add('lose');
  } else {
...
async function ensureChallengeLinkReady(){
  ...
  try{
    ...
    const msg = `🌊 I just charted the World Seas Navigator and scored ${currentAvgScore}%. Think you can pin the world's seas closer? Take the same targets: ${link}`;
    document.getElementById('wa-share').href = 'https://wa.me/?text=' + encodeURIComponent(msg);
    document.getElementById('tg-share').href = 'https://t.me/share/url?url=' + encodeURIComponent(link) + '&text=' + encodeURIComponent(`🌊 Think you can beat my World Seas Navigator score of ${currentAvgScore}%?`);
